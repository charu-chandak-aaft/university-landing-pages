...
<head>
	...
	<title>AAFT University | Best private universities in India</title>
	<meta name="description" content="Discover AAFT University – one of the best private universities in India offering top programs in media, design, film, and more. Apply now!">
  <meta name="keywords" content="Best private universities in India">
...
background: linear-gradient(to bottom, rgba(255,0,0,0) 0%,rgba(255,0,0,0.65) 100%);
			...
			@media screen and (max-width:480px) {
				...
				.hero_sec_cinema_new .align-items-center {
					margin-top: 200px;
				}
		...
		<style>
			...
			.navbar {
				...
				opacity: 0.98;
				z-index: 100;
				box-shadow: 0 4px 8px 0 rgb(0 0 0 / 5%), 0 6px 10px 0 rgb(0 0 0 / 5%);
			}
		...
		<nav class="navbar">
			<div class="navbar-container container">
				...
				<img src="assets/img/univ-logo.webp" title="AAFT | School of cinema" alt="AAFT | School of cinema"
					class="img-fluid lplogo">

				<a class="d-none"
					style="background: #ed1b24; text-align: center; padding: 10px 12px; border-radius: 4px; font-weight: bold; text-decoration: none; order:3; color:#fff;">
					<i class="bx bx-phone"></i>
					<?php echo getDidnumber($utm_campaign); ?>
				</a>
			</div>
		</nav>
				...
				<div class="row d-flex align-items-center">
					<div class="col-lg-8 col-md-8">
						<div class="hero_sec_content">
							<img src="assets/img/univ-aaft.png" alt="univ" class="slid-ico"
								style="display:block!important; filter: contrast(1.1); margin-bottom:20px; width:70px!important; height:70px!important;">
							...
							<a href="#enquire"><button
									style="background-color: #ed1b24; padding:10px; width:200px; text-align: center; color:#ffffff;">Enquire
									Now</button></a><br>&nbsp;<br>
		...
		<style>
			.register-form-home-lp {
				background-color: #F2F4F6;
				padding: 40px 20px;
			}

			.register-form-home-lp input[type=text],
			.register-form-home-lp input[type=email],
			.register-form-home-lp input[type=tel],
			.register-form-home-lp select,
			.register-form-home-lp input[type=submit] {
				height: 40px;
				width: 100%;
				border: none;
			}
			...
			<div class="container">
				<div class="row reverse">
					<div class="col-sm-12">
						...
						include('inc/form-home-lp.php');
						?>
					</div>
					<div id="about" style="height:40px;"></div>
				</div>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="about_text">
							<h2>About AAFT</h2>
							<p>AAFT has been providing education in media and arts for the past 30 years. We offer 50+
								professional courses in various fields of Cinema, Journalism and Mass Communication,
								Performing Arts, Animation, Hospitality and Tourism, Still Photography, Advertising, PR
								and Events and Fashion Design.</p>
						</div>
					</div>
		...
		<style>
			...
			.admission_open .admn_text {
				display: flex;
				justify-content: center;
			}

			.admission_open .admn_dt {
				color: #ED3237;
				margin-bottom: 40px;
			}

			.admission_open .txt_box {
				text-align: left;
				margin-left: 20px;
			}

			.admission_open .degree {
				font-size: 14px;
				color: #9C9B9B;
				line-height: 0px;
			}
		...
		<section class="admission_open">
			<div class="container">
				...
				<p class="admn_dt">August 2025 Batch</p>
				<div class="row">
					<div class="col-sm-4">
						<div class="admn_text">
							<div class="img_box">
		...
		<section class="schools">
			<div class="container scl">
				<div class="row">
					...
					<div class="col-sm-7">
						<h2>Fifteen Creative Streams to Pursue Your Passion</h2>
						<p>Wellness | Hospitality | Law | Doctoral Research | Fine Arts | Performing Arts | Management |
							Interior Design | Fashion | Digital Marketing | Animation | Journalism & Mass Communication
							| Photography | PR & Events | Cinema</p>
				...
				<div class="row chn">
					...
					<div class="col-sm-5 order-sm-1">
						<div class="abt_ch">
							...
							<p>Persistent and systematic efforts play an indispensable part in human progress. In this
								modern era, media has the power to control human mind, ideas and values. Media
								professionals has a crucial role in adequately inform, educate and entertain the masses.
								Therefore, we continuously strive to act as a catalyst in the progression of human
								self-esteem and cultural inheritance through research, teaching, and resources to
								develop skills essential to the film, media and arts industry.</p>
		...
		<style>
			.recognition {
				...
				background-image: url("assets/img/home-v1/madel.webp");
				background-repeat: no-repeat;
				background-position: right top;
				background-size: 325px;
			}

			.recognition .award_box {
				display: flex;
				align-items: flex-start;
				margin-bottom: 20px;
			}

			.recognition .awd_img img {
				width: 80px;
			}
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="award_box">
									...
									<div class="awd_txt">
										...
										<p>AAFT University is approved by University Grants Commission (UGC) and is
											competent to award degrees as specified by UGC under section 22 of UGC Act,
											1956.</p>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="award_box">
									...
									<div class="awd_txt">
										...
										<p>With inspiring educational pedagogy and state-of-the-art infrastructure, we
											give students an opportunity few institutes offer.</p>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="award_box">
									...
									<div class="awd_txt">
										...
										<p>An Act to further amend the Chhattisgarh Private Universities (Establishment
											and</p>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="award_box">
									...
									<div class="awd_txt">
										<p class="ttl1">MHRD</p>
										<p>The Ministry of Human Resource Development, formerly Ministry of Education.
										</p>
									</div>
								</div>
							</div>
		...
		<section class="recruiters">
			<div class="container">
				...
				<p>AAFT is dedicated to working toward facilitating a strong foundation for the students to embark on
					their professional journey. We feel honored and privileged to be associated with the leading
					companies across all industries.</p>
				<div class="img_bx">
		...
		<style>
			.apply_now {
				padding: 40px 20px;
				background-image: url("assets/img/home-v1/appl_bg.jpg");
				background-repeat: no-repeat;
				color: #fff;
				background-size: cover;
			}
		...
		<section class="alumni">
			<div class="container">
				...
				<p class="mb-5">AAFT boasts of a network of 20000+ global alumni. Our alumni work at well-known news and
					media agencies, MNCs, film production houses, music companies, fashion designing companies, PR
					firms, event management companies, etc.</p>
				<div class="row">
		...
		<section class="events">
			<div class="container">
				<h2>Our Events</h2>
				<p class="mb-5">Our Board of Directors are excellent leaders who curate and invite the top of the
					faculty of today’s times
				...
				<div class="row">
					<div class="col-sm-4 almn">
						...
						<div class="txtg">
							...
							<p class="pt22">Sunil Shetty's discourse on acting emphasizes the importance of honesty,
								preparation, listening and responding, versatility, and collaboration in the craft of
								acting.</p>
						</div>
					</div>
					<div class="col-sm-4 almn">
						...
						<div class="txtg">
							...
							<p class="pt22">Soha Ali Khan's discourse on acting emphasizes the importance of empathy,
								listening, preparation, vulnerability</p>
						</div>
					</div>
					<div class="col-sm-4 almn">
						...
						<div class="txtg">
							...
							<p class="pt22">Manjot Singh shared his insights and thoughts on the challenges and
								opportunities that come with being a part of the Indian film industry</p>
						</div>
					</div>
						...
						<div class="upcomingBox rounded py-3 px-5">
							<div class="row">
								<div class="col-sm-6">
									...
									<p>Admissions are closed once the requisite number of participants enroll for the
										upcoming cohort. Apply early to secure your seat.</p>
								</div>
		...
		<section class="apply-for-admission-section">
			<div class="container py-5">
				<div class="row">
					...
					<div class="col-sm-7 d-flex justify-content-center flex-column application-right p-5"
						style="background-image: url('assets/img/home-v1/admission-bg.webp'); background-repeat: no-repeat; background-size: cover;">
						<h2 class="mb-3">Online Application</h2>
						<p class="mb-5">Students seeking admission to AAFT will have to take a mandatory AAFT Global
							Entrance Exam (AAFT GEE). The exam consists of an aptitude test and a personal interview
							(via offline or online modes) based on the aspirant's chosen discipline. Applications to
							AAFT’s programs can be submitted online.</p>
						<a href="#enquire" class=""
							style="background-color: #ed1b24; text-decoration:none; padding: 10px; width: 150px; color:#FFFFFF; text-align: center;"><span>Enquire
								Now</span></a>
					</div>
				</div>
				<div id="campus"></div>
		...
		<section class="campus">
			<div class="container">
				<h2>Our Campus</h2>
				<p>Raipur is growing as an education hub of Central India, propelling opportunities to young minds like
					never before. It is a fascinating city with many scenic views and numerous things to do.</p>
		...
		<?php include('inc/contact-details-university1.php'); ?>
