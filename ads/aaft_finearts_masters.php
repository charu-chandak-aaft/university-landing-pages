...
<title>Fine Arts Masters Programme | AAFT University</title>
		...
		<div class="row b-sec">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Master of Fine Arts">Master of Fine Arts</option>';				
...
<section class="syllabus">
	<div class="container">
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="course2" role="tabpanel">
...
<?php include('inc/contact-details-finearts3.php'); ?>	
