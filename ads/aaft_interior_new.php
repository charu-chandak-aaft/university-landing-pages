...
<title>Interior Designing Course in India | AAFT University </title>
<meta name="description" content="AAFT University offers one of the leading Interior Designing courses in India. Blend creativity with functionality and turn your passion into a professional career.">
  <meta name="keywords" content="Interior Designing Course">
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/interior-v1/interior-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: contain;}
	...
	.banner-area .right-area{padding:20px;	background: #2a181894;border-radius: 10px; backdrop-filter: blur(10px);}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/interior-v1/interior-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Interior Design Programs| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - July 2025 Batch</p>
					</div>
					<p class="hr3">Surprise The World with Your Breathtakingly Designed Spaces</p>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="B.Sc. in Interior Design">B.Sc. in Interior Design</option><option value="Bachelor of Design in Interior Design">Bachelor of Design in Interior Design</option><option value="Master of Design in Interior Design">Master of Design in Interior Design</option><option value="Diploma in Interior Design">Diploma in Interior Design</option>';				
			...
			<div class="row">
				<div class="col-sm-5">
					...
					<ul>
						...
						<li>Bachelor of Design in Interior Design</li>
						<li>Master of Design in Interior Design</li>
					</ul>
				</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Interior Design experience to fit your career goals</p>
							</div>
						</div>
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Learn to Measure, Plan, and Design the Best of the Spaces</p>
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2" aria-expanded="true">     
							<span class="title">Master the Interior Design Techniques From all Aspects</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2" class="collapse show" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential Interior Design topics such as understanding of interior design concepts, vaastu science principles, and prepare them for leadership roles in the interior design industry.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our  Interior Design programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in B.Des. Interior Design, M.Sc. in  Interior Design, M.Des. in Interior Design, and Diploma in Interior Design.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>We provide real-world examples of the Interior Design Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>Our  Interior Design programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the Interior Design Techniques From all Aspects</p>
					<p class="c_dtl">We offer a variety of courses that cover essential Interior Design topics such as understanding of interior design concepts, vaastu science principles, and prepare them for leadership roles in the interior design industry.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our  Interior Design programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in B.Des. Interior Design, M.Sc. in  Interior Design, M.Des. in Interior Design, and Diploma in Interior Design.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Hands-on Equipments Learning</p>
					<p class="c_dtl">We provide real-world examples of the Interior Design Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Win-Win! Collaboration and Communication</p>
					<p class="c_dtl">Our  Interior Design programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
	...
	<div class="container">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="course2" role="tabpanel">
				<div class="accordion" id="accordionExample2a">
					<div class="card">
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Interior Design Programs | 2/3/4 years</span></p>
					<ul>
						...
						<li>Get placed at top production companies in the Interior Design Industry</li>
	...
	<div class="container">
		...
		<div class="row mb-3">
			<div class="col-sm-3 col-12 img-box mb-4">
				<img alt="image" loading="lazy" class="img-fluid" src="assets/img/dean/sunita-kohli.webp"
					style="color: transparent;border-left: 4px solid #ed4c38" />
			</div>
			<div class="col-sm-9 col-12 content">
				<h5>Sunita Kohli</h5>
				<p>Step into the world of design excellence at AAFT, where the illustrious Ms. Sunita Kohli leads a
					transformative journey in interior design education. A distinguished figure in the field, Ms. Kohli
					has redefined the art of interiors with her extraordinary vision and dedication to preserving
					architectural heritage. Recipient of the prestigious Padma Shri, her career is a testament to her
					unparalleled expertise and contributions to design, restoration, and craftsmanship. Her work, known
					for its timeless elegance and cultural relevance, has set benchmarks in the industry. As the new
					Industry Dean for the AAFT School of Interior Design, Ms. Kohli brings her wealth of knowledge to
					inspire and mentor the next generation of designers. Under her guidance, students will explore
					innovative design approaches and embrace the art of creating spaces that leave a lasting impact.</p>
			</div>
		</div>
	</div>
</section>
		...
		<div class="swiper learner">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/interior-v1/devesh.webp" alt="">
						<div class="text-holder">
							<p class="nm">Devesh Keshwani</p>
							<p class="des">Asst. Professor & School Incharge</p>
							<p class="dtls">He is an Interior Designer with more than 8 years of professional experience. He has expertise in project management, space planning, computer-aided design, and miniature model making. He has been the I/C Head of the School of Interior Design at AAFT University for the past 3 years.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/interior-v1/nuria.webp" alt="">
							<div class="text-holder">
								<p class="nm">Nuria Niyaz</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">She is an architect and urban designer, holding a master's degree in Urban design. With a passion for combining beauty and functionality in her designs, she has completed various internships and freelance projects, interacting with clients to bring their ideas to life.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/interior-v1/naina.webp" alt="">
							<div class="text-holder">
								<p class="nm">Naina Agrawal</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">She is a certified interior designer with expertise in sustainable design, space management, and model making. With considerable experience, she has worked on various residential and commercial design projects. Currently, she is an Assistant Professor at the School of Interior Design.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/interior-v1/prajakta.webp" alt="">
							<div class="text-holder">
								<p class="nm">Prajakta Rahate Bhale</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">She is a CREST fellow and has also been awarded the 'Climate Change PhD. Scholarship' by EPCO, M.P. Government. She also has a good academic experience in 'A' listed colleges in Gurugram and Jaipur.</p>
		...
		<div class="swiper why">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/interior-v1/azim.webp" alt="">
							<div class="text-holder">
								<p class="nm">Azim </p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“As an interior design graduate from AAFT, Noida, I am grateful for the invaluable contribution of highly educated and enthusiastic faculties in shaping my career. I am happy to have pursued my bachelor's degree at AAFT.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/interior-v1/preeti.webp" alt="">
							<div class="text-holder">
								<p class="nm">Preeti Singh</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“Having completed my B.Sc. in Interior Design from AAFT College, I gained extensive knowledge and skills in the field. The college provided me with opportunities to reach new heights, supported by dedicated and supportive faculties who were available round the clock.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/interior-v1/shivraman.webp" alt="">
							<div class="text-holder">
								<p class="nm">Shivraman</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“I completed my Diploma in Interior Design from AAFT, Noida. Prior to joining, I had no knowledge of interior design. The college provided me with opportunities to learn and grow. The supportive faculties and department deserve my utmost respect, love, and gratitude.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/interior-v1/kavya.webp" alt="">
							<div class="text-holder">
								<p class="nm">Kavya Dubey</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“I transitioned from a science background to pursue my passion for interiors. I completed a PG diploma from the School of Fashion and Design at AAFT Noida. Currently, I am employed as a Design Expert at Home Lane Ghaziabad.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Interior Design is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for Interior Design, thereby creating a cohort of promising future leaders.</p>
		<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor Degree Program in Interior Design at AAFT University has a duration of three years for B.Sc. in Interior Design and four years for B.Des. in Interior Design.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>After the Interior Design Program at AAFT University, students get various career opportunities in fields such as Architect, Textile Designer, Estates manager, Furniture designer, Graphic designer, Product designer, and Stylist.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue an Interior Design Degree program without an Architectural background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Interior Design Degree program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of Interior Design principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-interior1.php'); ?>	
