...
<title>Diploma in Dance | AAFT University Raipur, Chhattisgarh</title>
<meta name="description" content="Join the Diploma in Dance at AAFT University, Raipur – Master various dance forms with expert guidance and kickstart your professional dance career today.">
  <meta name="keywords" content="Diploma in Dance ">
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT University | School of Music" alt="AAFT University | School of Music" class="img-fluid lplogo">
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/dance-v1/dance-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: contain;}
	...
	.banner-area .right-area{padding:20px;	background: #36363654; border-radius: 10px; backdrop-filter: blur(10px);}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/dance-v1/dance-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: contain;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Dance  Program| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - July 2025 Batch</p>
					</div>
					<p class="hr3">Get the world on its twinkling toes with your Dance</p>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Dance experience to fit your career goals</p>
							</div>
						</div>
...
<section class="excellence">
	<div class="container">
		...
		<p>Our Dance program is accredited by prestigious organizations, ensuring the highest standards of quality and value in business education.</p>
		<div class="row">
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Learn, Practice, and Perform at Your Best</p>
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2a" aria-expanded="true">     
							<span class="title">Master the Dance Techniques From all Aspects</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential Dance topics such as  the innovative aspects of dance styles, Footwork and Hand movement of Dance, Dance exercises.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Diploma in Dance program offers and teaches students various topics that allow them to focus on specific areas of interest.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We provide real-world examples of the Dance Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>Our Diploma in Dance program requires students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the Dance Techniques From all Aspects</p>
					<p class="c_dtl">We offer a variety of courses that cover essential Dance topics such as  the innovative aspects of dance styles, Footwork and Hand movement of Dance, Dance exercises.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Diploma in Dance program offers and teaches students various topics that allow them to focus on specific areas of interest.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Hands-on Equipments Learning</p>
					<p class="c_dtl">We provide real-world examples of the Dance Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Win-Win! Collaboration and Communication</p>
					<p class="c_dtl">Our Diploma in Dance program requires students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
...
<section class="syllabus">
	<div class="container">
		...
		<div class="bbttnn">
			<div class="btn11">Master classes & Workshops: <span class="red"> 3+ </span> <span class="d-sm-block d-none"> | </span></div> 
			<div class="btn11">Celebrity Interactions: <span class="red"> 2+ </span> <span class="d-sm-block d-none"> | </span></div>
			<div class="btn11">Projects: <span class="red"> 5+ </span></div>
			<a href="#enquire"><button class="btn-info2">Inquire Now</button></a>
		</div>
		
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma in Dance</a>
			  </li>
		</ul>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Diploma in Dance Program | 1 year</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Get to learn with creative minds from 120+ countries</li>
						<li>Get placed at top production companies in the Dance Industry</li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="application-info">
	...
	<style>
		...
		.instructor-sec .f-box img{position: absolute; top: -70px; left: 45%;}
	...
	@media only screen and (max-width: 600px) {
			.instructor-sec .f-box img{position: absolute; top: -70px; left: 104px;}
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for Dance, thereby creating a cohort of promising future leaders.</p>
		<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ul>
								<li>Candidates must have a minimum of 50% marks</li>
							</ul>
						</div>
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Diploma in Dance Program at AAFT University has a duration of one year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<p>After the Diploma in Dance Program at AAFT University, students get various career opportunities in fields such as Dancer, Choreographer, Dance Teacher, and Dance Therapist.</p>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Dance Degree program without a dance background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Diploma in Dance program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of dance principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
