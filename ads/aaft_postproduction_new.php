...
<title>Post Production | AAFT University</title>
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/postproduction-v1/postp-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: cover;}
	...
	.banner-area .right-area{padding:20px;	background: #7272723b;border-radius: 10px; backdrop-filter: blur(10px);}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/postproduction-v1/postp-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Post-Production Diploma Program| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - August 2025 Batch</p>
					</div>
					<p class="hr3">Bring Changes To the Scene Like a Pro</p>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					<?php
					$pageOption="Post Production";
					$schoolOption="School of Cinema";
					$courseOption= '<option value="Diploma in Post-Production">Diploma in Post-Production</option>';				
	...
	<div class="container">
		<div class="duration-content">
			<div class="row notice1">
				...
				<hr/ class="d-block d-sm-none" style="width:92%;">
				<div class="col-sm-2 col-6">
					<div class="item6"><h5>Eligibility</h5><p style="font-size: 14px;">10</p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2a" aria-expanded="true">     
							<span class="title">Master the Editing and Special Effects Techniques</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential Post-production topics such as fundamentals of sound recording, sound effects in film production, dubbing, 2D and 3D animation techniques, and fundamentals of visual effects.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Post-Production programs offer elective topics that allow students to focus on specific areas of interest.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>Our Post-Production programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the Editing and Special Effects Techniques</p>
					<p class="c_dtl">We offer a variety of courses that cover essential Post-production topics such as fundamentals of sound recording, sound effects in film production, dubbing, 2D and 3D animation techniques, and fundamentals of visual effects.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Post-Production programs offer elective topics that allow students to focus on specific areas of interest.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
			...
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">Our Post-Production programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma</a>
			  </li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Post-Production Program | 1 year</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for a Bachelor Degree, Master Degree, and Diploma Program for other Cinema courses</li>
		...
		<div class="row">
			...
			<div class="col-sm-5">
				<div class="add-info">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Post Producers</li>
						<li>Editors</li>
						<li>Audio or Sound Designers</li>
						<li>Colorists</li>
						<li>VFX managers </li>
					</ul>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Diploma in Post-Production program at AAFT University has a duration of one year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Diploma in Post-Production program at AAFT University is a minimum of 50% marks in Class 10th in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<p>Graduates of the Diploma program at AAFT University have various career opportunities in fields such as Post producer, Editor, Colorists, Audio Engineer, and VFX manager.</p>
				</div>
			</div>
		</div>
			<div class="card">
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Post-Production Diploma program without a cinema background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Post-Production Diploma program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of post-production principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-post-production1.php'); ?>	
