...
<title>Bachelor's of Science in Nutrition & Dietetics Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>B. Sc. in Nutrition & Dietetics Program | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - July 2025 Batch</p>
					</div>
					<p class="hr3">Start your transformative journey to become part of the top 1% in the field of nutrition and wellness at AAFT School of Wellness.</p>
					<h3>On-campus program for the August 2025 Batch at AAFT University</h3>
				</div>
			</div>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Bachelor of Science in Nutrition & Dietetics">Bachelor of Science in Nutrition & Dietetics</option>';				
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Nutrition & Dietetics Programs | 3 years</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends</li>
						<li>Additionally, you can apply for a  Master's Degree, or Diploma Program</li>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor's Degree Program in Nutrition & Dietetics at AAFT University has a duration of three years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Bachelor's is a minimum of 50% of marks in 10+2 in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-health1.php'); ?>	
