...
<title>Photography Diploma Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Photography Program| AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Diploma in Photography">Diploma in Photography</option>';				
	...
	<div class="container">
		<div class="duration-content">
			<div class="row notice1">
				...
				<hr/ class="d-block d-sm-none" style="width:92%;">
				<div class="col-sm-2 col-6">
					<div class="item6"><h5>Eligibility</h5><p style="font-size: 14px;">10+2 / Graduate</p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About School of Photography</h2>
			<p>Embark on a transformative voyage, where every captured moment becomes a timeless masterpiece, weaving stories that stir hearts and inspire minds. Step into the world of visual art and storytelling with AAFT School of Photography. From mastering composition and lighting techniques to exploring experimental genres, students receive hands-on training that transcends conventional boundaries. AAFT School of Photography offers a comprehensive course on how to click photos, camera handling, and camera angles for different scenarios like family portraits, landscapes, aerials, products, wildlife, and much more.</p>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>World-class faculty with real-world experienceWorld-class faculties with real-world experience </p>
							</div>
						</div>	
						<div class="brdr"></div>
					</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Practical projects and simulations to elevate your skills</p>
							</div>
						</div>	
						<div class="brdr"></div>
					</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your experience to fit your career goals</p>
							</div>
						</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Get EDGE and CARE support from industry experts </p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						...
						<li>Recognized for Excellence</li>
					</ul>
					</div>
				</div>
			</div>
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma in Photography</a>
			  </li>
		</ul>
				...
				<div class="accordion" id="accordionExample">
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									...
									<li>Basics of Arts in Framing</li>
									<li>Lighting Techniques</li>
									<li>Photojournalism</li>
									<li>Optics</li>
									<li>Photo Editing - I (Photoshop)</li>
									<li>Photo Walk</li>
								</ul>
							</div>
						</div>
					...
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Table-top Photography</li>
									<li>Fashion Photography</li>
									<li>Landscape and Wildlife Photography</li>
									<li>Basics of Designing </li>
									<li>Advance Photo Editing (Photoshop and Lightroom)</li>
									<li>Exhibiting Photography Work</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Cinema program | 3/2 years</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for a Bachelor Degree and Master Degree and Diploma Program</li>
						<li>Get placed at top production companies in the Entrainment industry</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-9 col-12 content">
				<h5>Rohit Chawla</h5>
				<p>Mr. Rohit Chawla, a celebrated photographer with over four decades of experience, has joined AAFT University as the Industry Dean of the School of Still Photography. Renowned for his avant-garde approach, minimalist design, and striking graphic style, Rohit’s illustrious career began in advertising at JWT before he founded his design and film production company. His globally acclaimed exhibitions, including Wanderlust, Tribute to Raja Ravi Varma, and Klimt - The Sequel, have been featured in private collections and prestigious museums. With a wealth of artistic vision and industry expertise, Rohit’s mentorship will empower AAFT’s photography students to explore contemporary techniques, innovative storytelling, and creative expression. His leadership marks a transformative chapter for AAFT, inspiring students to achieve excellence and carve their unique identities in the world of photography.</p>
			</div>
		</div>
	</div>
</section>
...
<section class="program1">
	<div class="container">
		<h2 style="text-align: center; line-height: 35px;">Our Hostel: Comfort. Cuisine. Connection.</h2>
		<div class="row main-div">
			<div class="row">
				<div class="col-sm-6">
					<div class="prog-info">
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>A Diploma in Still Photography program at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Bachelor Degree program is a minimum of 50% of marks in 10+2 in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-photography4.php'); ?>	
