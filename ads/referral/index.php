...
<style>
	...
	.heroBanner{background-color: #ED3237; background-image: url("images/heroBanner.jpg"); background-repeat: no-repeat; background-size: 45% auto; background-position: right center;margin-top: 70px; }
	.heroBanner h1{font: normal 34px/45px Work Sans; color: #FFFFFF;}
	.heroBanner p{font: normal 18px/30px Work Sans; color: #FFFFFF;}
	.heroBanner .custBtn{width: 165px; background: transparent; border: none; color: #FFFFFF; border: 1px solid #FFFFFF;}
	...
	.howWorks .numCount{height: 55px; width: 55px; background: #FFE9E9; border-radius: 50%; border: 1px solid #ED3237; display: flex; align-items: center; justify-content: center; margin-right: 15px;}
...
.hero_sec_advertising_new{margin-top:70px;}
	.workBox{padding: 40px;}
	.bottomTxt{padding:40px 0;}
	.howWorks{padding:40px 0;}
...
@media (max-width: 500px){
	...
	.bottomTxt{padding:10px 10px;}
	.howWorks{padding:10px 10px;}
}
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<a href="https://aaft.edu.in/ads/refferal-program/form.php" class="d-none d-sm-block" style="color:#ffffff; background: #ff500d;text-align: center; padding: 10px 12px; border-radius: 4px; font-weight: bold; text-decoration: none; order:3;">
		Apply Now</a>
	</div>
</nav>	
...
<!--  navigation--->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-7 py-5">					
					<h1>AAFT University's Refer-a-Friend Program:</h1>
					<p>Get benefits worth Rs. 5,000 on a degree program enrolment and Rs. 2,500 for a diploma program enrolment.</p>
					<p>Are you passionate about learning and looking to share your enthusiasm with friends? In order to thank you for spreading the word about AAFT University and the outstanding education we offer, we are pleased to announce the launch of our Refer-a-Friend Program.</p>
					<a href="<?php echo $finalUrl; ?>" class="custBtn btn mt-4">Refer Now</a>
				</div>
			...
			<div class="row">
				<div class="col-sm-6 pr-sm-0">
					<div class="workBox">
						...
						<div class="process">
							<div class="numCount">1</div> <div class="numText"><p><span style="font-weight: 500;">Referral Form:</span> Referred individuals must fill out the form on the website and enter the OTP to confirm their submission.</p></div>
						</div>
						<div class="process">
							<div class="numCount">2</div> <div class="numText"><p><span style="font-weight: 500;">Personalized Assistance:</span> Admissions advisors will contact the referred person to offer guidance about the courses.</p></div>
						</div>	
						<div class="process">
							<div class="numCount">3</div> <div class="numText"><p><span style="font-weight: 500;">Enrollment:</span> Once the referred friend enrolls and completes the first semester, celebrate your success.</p></div>
						</div>
						<div class="process">
							<div class="numCount">4</div> <div class="numText"><p><span style="font-weight: 500;">Choose Your Reward:</span> As a token of our appreciation, you get to choose a reward of your choice.</p></div>
						</div>
					</div>
				</div>
				<div class="col-sm-6 pl-sm-0"><img src="images/howWorkLady.jpg" class="w-100" style="padding: 25px 0;"></div>
			</div>
		</div>
	</section>	
	...
	<section class="bottomTxt">
		<div class="container">
			<h3 class="my-3">What are the Benefits?</h3>
			<h5>Option 1: Go on a spending binge with an Amazon Gift Card </h5>
			<p>You will receive a Rs. 5,000 Amazon gift card on a degree program enrolment and Rs.2,500 Amazon gift card on a diploma program enrolment that may be used toward the purchase of anything from Amazon's extensive catalog.</p>
			
			<h5>Option 2: Get a Waiver on your Tuition Fee</h5>
			<p>Interested in developing your abilities further? At AAFT University, you have the option of waiving off Rs. 5,000  or Rs. 2,500 from your own course fees. With this method, you may reduce the cost of your education without sacrificing the quality of your education.</p>
		</div>
	</section>
