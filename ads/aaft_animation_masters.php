...
<title>Animation Master Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>M.Sc. in Animation & VFX Program | AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Master of Science in Animation & VFX">Master Of Science in Animation & VFX</option>';				
...
<section class="program1">
	<div class="container">
		<div class="about">
			...
			<p>The AAFT School of Animation provides practical and industry-relevant education in animation, VFX, game design, and the Unreal Engine. Our top-notch animation degree courses, crafted by industry experts, enable students to develop a robust portfolio through various projects. Explore advanced opportunities with options such as a master's in animation or animation masters programs, which are designed to elevate your skills and open doors to exciting career prospects. Consider pursuing a master's in animation and VFX at one of the premier universities for animation studies.</p>
		</div>
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">M.Sc. in Animation & VFX</a>
			  </li>
		</ul>
				...
				<div class="accordion" id="accordionExample">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									...
									<li>Implementation of animation principles & adopting acts in animation.</li>
									<li>Polishing the communication skills and navigating the communication acumen of PR skills to build a communication strategy.</li>
									<li>Learn various aspects of filmmaking</li>
						...
						<div id="collapseThree" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								...
								<ul>
									...
									<li>Explore the arena of 3d modeling texturing and rigging.</li>
									<li>Learn advanced 3d animation as a generalist.</li>
									<li>Develop the concept of advanced rotoscope tracking & compositing.</li>
					...
					<div class="card">
						...
						<div id="collapseFour" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Introduction to the Advanced Dynamic Simulation.</li>
									<li>Creating a portfolio of 3d animation vfx.</li>
									<li>Learning to create projects of augmented reality & virtual reality.</li>
									<li>Creating a solid work of at least 1 min visual for the project.</li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Master in Animation & VFX Program | 2 years</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for a Diploma Program or P.hD</li>
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Master's Degree Program in Animation & VFX at AAFT University has a duration of 2 years.</li>
						</ul>
					</div>
				</div>
			</div>
...
<?php include('inc/contact-details-animation1.php'); ?>	
