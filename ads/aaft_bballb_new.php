...
<title>BBA LLB | AAFT University</title>
<meta name="keywords" content="bachelor of laws llb, bba llb colleges, bba llb course, llb integrated course, ba llb">
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT University | School of Law" alt="AAFT | School of Law" class="img-fluid lplogo">
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/llb-v1/llb-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: cover;}
	...
	.banner-area .right-area{padding:20px;	background: #46464654; border-radius: 10px; backdrop-filter: blur(10px);}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/llb-v1/llb-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: contain;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>BBA-LLB Programs| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - July 2025 Batch</p>
					</div>
					<p class="hr3">Shape the World of Commerce and Justice with AAFT, Raipur</p>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					<?php
					$pageOption="BBA-LLB";
					$schoolOption="School of BBA-LLB";
		...
		<div class="duration-content">
			<div class="row notice1">
				<div class="col-sm-2 col-6">
					<div class="item1"><h5>Duration</h5><p>5 Years</p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="program1">
	<div class="container">
		...
		<div class="about">
			<h2>About the AAFT School of Law</h2>
			<p>At AAFT University, located in the heart of Raipur, Chhattisgarh, our B.B.A LL.B program stands as a beacon of excellence in legal education, combining the dynamic fields of business administration and law into a five-year integrated LLB course. Designed to cater to the ambitious aspirations of those keen to make their mark at the intersection of law and business, this program is among the finest B.B.A LL.B course available in Raipur.</p>
			<p>The B.B.A LL.B course, supported by a thorough preparation for the B.B.A LL.B entrance exam, paves the way for access to integrated LL.B courses that are not just academically rigorous but also rich in practical experiences. As one of the leading colleges for B.B.A LL.B in Raipur, Chhattisgarh, AAFT University is committed to fostering an educational environment where theoretical principles are seamlessly blended with real-world applications.</p>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your BBA-LLB experience to fit your career goals</p>
							</div>
						</div>
...
<section class="excellence">
	<div class="container">
		...
		<p>Our B.B.A LL.B program is accredited by prestigious organizations, ensuring the highest standards of quality and value in business and law education.</p>
		<div class="row">
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Stand among the top 1% of Legal Advisors</p>
		...
		<div class="row">
			<div class="col-sm-3">
				<div class="adv-grp">
					...
					<p class="adv-p1">5-Day</p>
					<p>Industrial Trip to Dubai</p>
					<div class="brdr"></div>
				</div>
			</div>
			<div class="col-sm-3">
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2a" aria-expanded="true">     
							<span class="title">Master the BBA-LLB Techniques From all Aspects</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential BBA-LLB topics such as understanding of the law, seminar paper, legal writing, moot court, internship, and professional ethics.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our BBA-LLB programs offer elective courses that allow students to focus on specific areas of interest.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We provide real-world examples of the Management & Legal Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>Our BBA-LLB programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the BBA-LLB Techniques From all Aspects</p>
					<p class="c_dtl">We offer a variety of courses that cover essential BBA-LLB topics such as understanding of the law, seminar paper, legal writing, moot court, internship, and professional ethics.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our BBA-LLB programs offer elective courses that allow students to focus on specific areas of interest.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Hands-on Equipments Learning</p>
					<p class="c_dtl">We provide real-world examples of the Management & Legal Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Win-Win! Collaboration and Communication</p>
					<p class="c_dtl">Our BBA-LLB programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="course1" role="tabpanel">
				<div class="accordion" id="accordionExample">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									...
									<li>Law of Torts and Consumer</li>
									<li>Protection</li>
					...
					<div class="card">
						<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseTwo">     
					...
					<div class="card">
						<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseTwo">     
					...
					<div class="card">
						<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseTwo">     
						...
						<div id="collapseSix" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									...
									<li>Property Law</li>
									<li>Investment and</li>
									<li>Competition Law</li>
									<li>Code of Criminal</li>
									<li>Procedure</li>
								</ul>
							</div>
						</div>
						...
						<div id="collapseSeven" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Labour Law-I</li>
									<li>Tax Law</li>
									<li>Law & Emerging Technologies</li>
									<li>Human Rights</li>
								</ul>
							</div>
						</div>
					...
					<div class="card">
						<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseTwo">     
					...
					<div class="card">
						<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseTwo">     
						<span class="title">Semester 9</span>
						<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
					...
					<div class="card">
						<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTwo">     
						<span class="title">Semester 10</span>
						<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>BBA-LLB Programs | 5 years </span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you get a 5-Days Dubai Industrial Visit</li>
						<li>Get placed at top Companies with the placement assistance</li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Law is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for Management & Law, thereby creating a cohort of promising future leaders.</p>
		<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
				...
				<div class="add-info">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						...
						<li>Legal Writer</li>
						<li>Legal Processing Outsourcing </li>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				<div class="card-header" data-toggle="collapse" data-target="#collapseOne223" aria-expanded="true">     
					<span class="title">1. What is the duration of the BBA-LLB Program?</span>
					<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
				</div>
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The BBA-LLB Degree Program at AAFT University has a duration of five years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the BBA-LLB Degree Program is a minimum of 50% of marks in 10+2 in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>After the BBA-LLB Degree Program at AAFT University, students get various career opportunities in fields such as Legal Writer, Business Consultant, Corporate Lawyer, Legal Compliance Officer, and Govt. Attorney.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue aBBA-LLB Degree program without a lawyer background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the BBA-LLB Degree program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of BBA-LLB principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-bballb2.php'); ?>	
