...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT | School of ecec mba" alt="AAFT | School of exec mba" class="img-fluid lplogo">
		...
		<div class="row d-flex align-items-center">
			<div class="col-lg-8 col-md-8">
				<div class="hero_sec_content">
					...
					<h2>In Executive MBA, Kick-start your Professional Career today!</h2>
					...
					<span class="tagline d-none">Application closes <span style="color:#FFFFFF"> August 2025</span></span>
				</div>
			</div>
...
<section class="white-sec-2" style="padding-bottom: 0; padding:0 0 0 0; background: none;">
	<div class="container">
		<div class="row reverse">
			...
			<div class="col-lg-4 col-md-4">
				<?php
				$pageOption="Executive MBA";
				$schoolOption="School of Management";
				$courseOption= '<option value="Executive MBA">Executive MBA</option>';				
...
<section class="white-sec" style="padding-top: 0;">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					<h1>About AAFT School of Executive MBA</h1>
					<p>Executive MBA programs typically focus on developing advanced management and leadership skills and are often designed to be completed while the student is still working full-time.<br>
					Unlike traditional MBA programs, which are geared toward recent college graduates, EMBA programs are tailored to the needs of mid-career professionals who are seeking to advance into senior management roles or positions of leadership in their organizations. They often feature a more specialized curriculum, with courses that focus on topics such as strategic management, global business, entrepreneurship, and innovation. The program duration of this course is of 1 year and is generally offered on weekends or in evening sessions to accommodate the schedules of working professionals.
</p>
				</div>
				...
				<div class="batchbox">
					<div class="batchbox-list">
						...
						<div class="pointer">
							<ul>
								<li>Importance Of Marketing Mix </li>
								<li>Understanding Human Resource Skills</li>
								<li>Importance of Leadership In Organization</li>
								<li>Need of GST and  Income Tax in Business</li>
								<li>Understanding of Export & Import </li>
							</ul>
						</div>
					</div>
					<div class="batchbox-list">
						<div class="group88">
							...
							<h5>August 2025 Batch</h5>
							<div class="course-list">
								<p><i class="bi bi-record2"></i>Degree Program (1 Year)</p>
		...
		<div class="row">
			<div class="col-sm-8 order-sm-1">
				<div class="body-copy-Black">
					<h2>Our Programs</h2>
					<p>Executive MBA concepts are better understood when they are employed practically through projects. To impart knowledge on powerful techniques used in Executive MBA research, marketing, and production, projects surely play a key role, and we at AAFT University ensure that our students get to work on various hands-on activities.</p>
				</div>
				<div class="">
			...
			<div class="col-sm-8">
				...
				<div class="row holder11">
					...
					<div class="col-sm-6 order-sm-1">
						...
						<ul>
							<li>Learning the Professional Pragmatism</li>
							<li>Development of Time management</li>
							<li>Learning Decision-making</li>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<p  style="color:#ffffff;">Many of the staff who currently teach on this course have extensive professional experience in a range of business sectors and many maintain links with industry through consultancy and training work.</p>
						<br>
...
<?php include('inc/contact-details-phd1.php'); ?>	
