...
<title>Event Management Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Event Management | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - January 2026 Batch</p>
					</div>
					<p class="hr3">Master PR and Advertising with hands-on learning approach </p>
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About School of Advertising, PR and Events</h2>
			<p>School of Advertising PR and Events is aimed at providing quality education in advertising, branding, communications, and events through its high-end infrastructure and hands-on training modules. AAFT is equipped with an in-house advertising and PR department, which gives hands-on experience in the field of marketing communications and events. Students are trained with necessary digital tools, and exposure is provided through corporate visits and special workshops imparted via industry experts during the course duration.</p>
		</div>
			...
			<div class="col-sm-4">
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						  <li>Master event budgeting, laws, photography during an event</li>
						  <li>Learn crowd management, risk management for large-scale events</li>
						  <li>Master staging, operation and logistics of event management</li>
						  <li>Get mentored by renowned Ad Filmmaker, Prahlad Kakar</li>
					</ul>
					</div>
				</div>
			</div>
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Learn the secrets of top event planners guided by industry experts. </p>
				...
				<div class="accordion" id="accordionExample">
					<div class="card">
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
                                     <li>Basics of Event Management</li>
									  <li>Staging Events</li>
									  <li>Event Financing and Accounting</li>
									  <li>Logistic and Entertainment Planning</li>
									  <li>Marketing for Events</li>
									  <li>Event Sponsorship and Hospitality</li>
					...
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									 <li>Basics of Set Designing</li>
									  <li>Law and Licensing for Events</li>
									  <li>Special Events</li>
									  <li>Multimedia Tools in Events</li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Diploma in Event Management | 1 year</span></p>
					<ul>
			...
			<div class="col-sm-5">
				<div class="add-info">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Event Manager</li>
						  <li>Activation Manager</li>
						  <li>Wedding Planner</li>
						  <li>Event Planner</li>
						  <li>Event Coordinator</li>
						  <li>Event Operations Manager</li>
						  <li>Stage Decorators</li>
						  <li>Set Designers</li>
						  <li>Exhibition Organizers</li>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				<div class="card-header" data-toggle="collapse" data-target="#collapseOne223" aria-expanded="true">     
					<span class="title">1. What is the eligibility criteria for pursuing a Diploma in Event Management?</span>
					<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
				</div>
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>Students who have passed or are appearing for their Class 12 (10+2) examination or have Graduated from any recognized board—CBSE, ICSE, IGCSE, IB, or any state board or University—are eligible to apply for a Diploma in Event Management course at AAFT.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseThree223" aria-expanded="false">
				<span class="title">2. What is the duration of a Diploma in Event Management?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for a Diploma in Event Management is 1 year.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFour223" aria-expanded="false">
				<span class="title">3. What can I do after completing a Diploma in Event Management?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
