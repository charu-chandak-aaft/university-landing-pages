...
<title>Cinema Bachelor Programme | AAFT University</title>
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT University | School of Cinema" alt="AAFT | School of bba" class="img-fluid lplogo">
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/cinema-v1/cinema-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: cover;}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/cinema-v1/cinema-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>B.A. in Cinema | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - July 2025 Batch</p>
					</div>
					<p class="hr3">International Affiliations with The Lee Strasberg Theatre & Film Institute, New York</p>
					<h3>On-campus programs for July 2025 Batch at AAFT University</h3>
				</div>
			</div>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					<?php
					$pageOption="Cinema";
					$schoolOption="School of Cinema";
					$courseOption= '<option value="BA in Cinema">BA in Cinema</option>';				
		...
		<div class="duration-content">
			<div class="row notice1">
				<div class="col-sm-2 col-6">
					<div class="item1"><h5>Duration</h5><p>3 Years</p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About School of Cinema</h2>
			<p>The AAFT's School of Cinema is a top-ranking film school offering industry-oriented training through undergraduate (UG), postgraduate (PG), and diploma courses in filmmaking. If filmmaking interests you, gaining professional knowledge and building relevant skill sets should be a priority. We are here to provide you with first-hand industry experience through our comprehensive training modules and advanced infrastructural facilities. Our filmmaking courses cover various aspects of the craft, including cinematography courses, film and TV production courses, and specialized courses in film direction and editing. Whether you aspire to study filmmaking for personal enrichment or pursue a career in the industry, our film school ensures that you receive the necessary training and exposure to succeed in this dynamic field.</p>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Cinema experience to fit your career goals</p>
							</div>
						</div>
			...
			<div class="col-sm-4">
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Make your own Short Films & Documentaries</li>
						<li>Film Shoot & Production House Visits</li>
						<li>Learn from top Filmmakers</li>
						<li>Student Portfolio Building</li>
					</ul>
					</div>
				</div>
			</div>
...
<section class="excellence">
	<div class="container">
		...
		<p>Our Cinema program is accredited by prestigious organizations, ensuring the highest standards of quality and value in business education.</p>
		<div class="row">
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Learn, Execute, and Create the next Award-winning film!</p>
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2a" aria-expanded="true">     
							<span class="title">Master the Cinematic Techniques</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential cinema topics such as lighting techniques, scriptwriting, shot listing, storyboard art, and production management.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Cinema programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in cinematography, direction, acting, or other specialized topics.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We provide real-world examples of the cinema world and how it runs by letting them focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>Our Cinema programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the Cinematic Techniques</p>
					<p class="c_dtl">We offer a variety of courses that cover essential cinema topics such as lighting techniques, scriptwriting, shot listing, storyboard art, and production management.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Cinema programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in cinematography, direction, acting, or other specialized topics.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Hands-on Equipments Learning</p>
					<p class="c_dtl">We provide real-world examples of the cinema world and how it runs by letting them focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Win-Win! Collaboration and Communication</p>
					<p class="c_dtl">Our Cinema programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
...
<section class="syllabus">
	<div class="container">
		...
		<div class="bbttnn">
			<div class="btn11">Master Classes & Workshops: <span class="red"> 13+ </span> <span class="d-sm-block d-none"> | </span></div> 
			...
			<div class="btn11">Value Added Courses: <span class="red"> 5+ </span> <span class="d-sm-block d-none"> | </span></div>
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">B.A. in Cinema</a>
			  </li>
		</ul>
			...
			<div class="tab-pane active" id="course1" role="tabpanel">
				<div class="accordion" id="accordionExample2">
					<div class="card">
						...
						<div id="collapseOne2" class="collapse show" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>Introduction to core forms and concepts of films.</li>
						...
						<div id="collapseTwo2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									...
									<li>Exploring the history of cinema.</li>
									<li>Importance of lighting and cinematography in storytelling.</li>
				...
				<div class="card">
					...
					<div id="collapseThree2" class="collapse" data-parent="#accordionExample2">
						<div class="card-body">
							<ul>
								<li>Developing advanced writing skills.</li>
								<li>Introduction to film sound.</li>
								<li>Importance of production designing in cinema.</li>
								<li>Understanding the production management.</li>
				...
				<div class="card">
					...
					<div id="collapseFour2" class="collapse" data-parent="#accordionExample2">
						<div class="card-body">
							<ul>
								<li>Understanding history of Indian cinema.</li>
								<li>Introduction to media ethics and laws.</li>
								<li>Learning the art of filmmaking.</li>
								<li>Understanding Mise-en-scène.</li>
				...
				<div class="card">
					...
					<div id="collapseFour2" class="collapse" data-parent="#accordionExample2">
						<div class="card-body">
							<ul>
								<li>Understand the film financing, production management, marketing and distribution.</li>
								<li>Knowing the history, significance, terminologies, types and formats of documentary for the purpose of application.</li>
								<li>Understand the importance and need for Storyboarding.</li>
								<li>Students will make a documentary film.</li>
				...
				<div class="card">
					...
					<div id="collapseFour2" class="collapse" data-parent="#accordionExample2">
						<div class="card-body">
							<ul>
								<li>Learn the process of making a degree film.</li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Bachelor of Arts in Cinema Program | 3 years</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for Diploma or Master's Program</li>
						<li>Get placed at top production companies in the Entertainment Industry</li>
					</ul>
				</div>
			</div>
		</div>
...
<style>
	.tonyd{padding: 0px 0;}
	.tonyd .rd-img{position: relative; width: 110%}
	.tonyd .oimgtxt{position: absolute; bottom: 0px; left:30px; background-color: #131313; border-radius: 16px; padding: 25px 20px 20px 20px; color:#ffffff; width: 155px;}
	.tonyd .rd-subh{font-size: 16px; line-height: 1.5; margin-bottom: 30px;}
	.tonyd .rd-head{margin-bottom: 28px; font-size: 16px; line-height: 25px; font-weight: 600;}
	.tonyd .oimgtxt p{margin-bottom: 10px; font-weight: 600;}
	.tonyd .rrooww{align-items: center;}
	.tonyd h2{font-size: 24px; margin-bottom: 20px; text-align: center;}

	@media (max-width: 640px) and (min-width: 100px){
		.tonyd .rd-head{margin-bottom: 20px; font-size: 16px; line-height: 25px; padding: 0 20px; }
		.tonyd .rd-subh{font-size: 16px; line-height: 1.5; margin-top: 30px;}
		/*.rina-dhaka span{font-size: 15px; font-weight: 600;}*/
		.tonyd .oimgtxt{left: 20px; background-color: #131313; border-radius: 16px; padding: 14px 10px 10px 10px; width: 115px; font-size: 12px;}
		
		.tonyd .rd-img{width: 100%}
	}
</style>
<div style="padding: 10px 0px 60px 0px;">
	<section class="tonyd">
		<div class="container">
			...
			<div class="row rrooww">
				<p class="rd-head d-block d-sm-none">Cinema's Finest: Dean, Industry - Anthony D'Souza <br><span>Shaping Tomorrow's Art!</span></p>
				<div class="col-sm-6 order-2 order-sm-1">
					<p class="rd-head d-none d-sm-block">Anthony D'Souza aka Tony D' Souza is an Indian film writer, director & producer. His film Boss, gave him a name as a commercially successful director. Some of his other famous films are Blue (2009), Azhar(2016). He has 25 years of industry experience.</p>

				</div>

				<div class="col-sm-6 order-1 order-sm-2">
					<img class="rd-img" src="assets/img/cinema-v1/anthony-cinema.webp" alt="">
					<div class="oimgtxt">
						<p>Anthony D'Souza</p>
						<p>Dean, Industry</p> 
					</div>						
		...
		<div class="swiper learner">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/cinema-v1/ashok.webp" alt="">
							<div class="text-holder">
								<p class="nm">Dr. Ashok Bairagi</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is an actor, director, and research scholar with an MA, MPhil, and PhD in Drama and Film Studies and Performing Arts. He has qualified UGC-NET, JRF, and SRF in 2016 and attended NSD Theater Workshop, 2011, and Appreciation Course at FTII, Pune in 2018.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/cinema-v1/mahendar.webp" alt="">
						<div class="text-holder">
							<p class="nm">Mr. Mahendar Rao</p>
							<p class="des">Asst. Professor</p>
							<p class="dtls">He is a Cinematographer, DOP, and AD maker with more than 14 years of experience. He has worked on various web series, advertisements, documentaries, and reality shows. He is currently associated as an Asst. Professor with the School of Cinema for Cinematography.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/cinema-v1/birju.webp" alt="">
							<div class="text-holder">
								<p class="nm">Mr. Birju Rajak</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is a postgraduate in cinema with a specialization in film and video editing from the Satyajit Ray Film and Television Institute (SRFTI). He has worked on many Hindi and non-Hindi films, shorts, documentaries, music videos, and web series for YouTube and OTT apps.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/cinema-v1/pritesh.webp" alt="">
							<div class="text-holder">
								<p class="nm">Mr. Pritesh Pandey</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is an actor and has a reputation for guiding and developing new talents through theater workshops and productions. Currently he is pursuing doctoral research. With a gold medal in M.A. and M.Phil. in film and theater, he has reached new heights in the realm of acting.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/cinema-v1/sumana.webp" alt="">
							<div class="text-holder">
								<p class="nm">Ms. Sumana Barman</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">She is an alumna of the Satyajit Ray Film & Television Institute. Her areas of specialization are Screenplay, Writing, and Direction. She has written and directed various short fiction and non-fiction films. She has considerable experience in advertising and filmmaking.</p>
					...
					<div class="s_holder">
						...
						<img src="assets/img/cinema-v1/ashok.webp" alt="">
							<div class="text-holder">
								<p class="nm">Dr. Ashok Bairagi</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is an actor, director, and research scholar with an M.A., M.Phil. and Ph.D. in Drama and Film Studies and PerformingArts. He qualified for UGC-NET, JRF, and SRF in 2016 and attended the NSD Theater Workshop in 2011, and appreciation Course at FTII, Pune, in 2018.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/performing-v1/chandran.webp" alt="">
							<div class="text-holder">
								<p class="nm">Dr. Chandan Singh</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is a professional KATHAK dancer from the Lucknow Gharana, with a mastery of bhav, expressions, and layakari in tatkar, he has showcased his talent in various prestigious dance festivals in India. Dr. Chandan Singh is a true representation of the grace and elegance of Indian classical dance.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/music-v2/abhinav.webp" alt="">
							<div class="text-holder">
								<p class="nm">Mr. Abhinav Sharma</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is a seasoned professional, excelling as a Music Producer, Sound Designer, Foley Artist, and Mix Master Engineer. With a solid 10-year track record in the film industry, he brings a wealth of experience and expertise. His 7 years of teaching experience have allowed him to share his knowledge & skills effectively.</p>
		...
		<div class="row">
			...
			<p class="shd">Discover where the success stories began - our alumni are thriving at these top-tier organizations!</p>
				<div class="placement-grid m-t-40">
					<div class="placement-list circle"><img src="assets/img/placement/acting-1.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/placement/acting-2.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/placement/acting-3.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/placement/acting-4.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/placement/acting-5.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/placement/acting-6.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/placement/acting-7.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/placement/acting-8.webp" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="swiper why">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/cinema-v1/ravikant.webp" alt="">
							<div class="text-holder">
								<p class="nm">Ravikant Jaiswal</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“The forever debate on whether or not a film school enhances your craft is totally gibberish. When I came to AAFT, I met a bunch of people coming from different races, cultures, and having evolved on their own. The transparency of the industry and student-teacher relationship is extent.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/cinema-v1/ashka.webp" alt="">
							<div class="text-holder">
								<p class="nm">Ashka Chaudhary</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“Before joining AAFT, I was not very sure about how the study of culture would be, but coming here changed a lot of my perspective about film, and that's all because of the teachers that I have. Every professor has their own style and vision for teaching cinema, which is great.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/cinema-v1/anushka.webp" alt="">
							<div class="text-holder">
								<p class="nm">Anushka </p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“As a student of School of Cinema, AAFT, I have had the amazing opportunity to explore my interest and talent in cinema through innovative infrastructure and teachers who tirelessly invest in quality education. ”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/cinema-v1/amay.webp" alt="">
							<div class="text-holder">
								<p class="nm">Amay</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“The environment provided by ASMS is extremely helpful for learning and exposure. The faculties and staff cooperate and support us at every step, helping us achieve more. Opportunities to perform in events are always provided to us which help us grow as an artist.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Cinema is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
					...
					<div class="col-sm-12 p-1">
						<img src="assets/img/cinema-v1/cinema_infra22.png" alt="">
					</div>
				</div>
			</div>
			<div class="col-sm-3 p-1 d-none d-sm-block">
				<img src="assets/img/cinema-v1/cinema_infra21.png" alt="">
			</div>
			<div class="col-sm-3 p-1">
				<img src="assets/img/cinema-v1/cinema_infra23.png" alt="">
			</div>
		</div>
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for cinema, thereby creating a cohort of promising future leaders.</p>
		<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				<div class="card-header" data-toggle="collapse" data-target="#collapseOne223" aria-expanded="true">     
					<span class="title">1. What is the duration of the Bachelor's Program?</span>
					<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
				</div>
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor's Degree Program in Cinema at AAFT University has a duration of 3 years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Bachelor's Degree program is a 10+2 in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<p>There are various other options, some of which are given here:</p>
					<ul>
						<li>Screenwriter</li>
						<li>Cinematographer </li>
						<li>Sound Designer </li>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Cinema Degree program without a cinema background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Cinema Degree program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of cinematic principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-cinemanew1.php'); ?>	
