...
<title>Music Production Diploma Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Music Production | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - January 2026 Batch</p>
					</div>
					<p class="hr3">Participate in International Workshops, Music Festivals and Global Competitions</p>
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About School of Music</h2>
			<p>AAFT School of Music empowers students to follow their passion through a wide range of courses in singing, music production, classical vocal, western music, DJing, instrumental music, among others. With a unique blend of degree and diploma programs, the AAFT School of Music offers a holistic learning environment designed to nurture creativity, technical skills and professional excellence in the world of music.</p>
		</div>
			...
			<div class="col-sm-4">
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Master instruments like tabla, guitar, drums and piano</li>
						  <li>Learn to design sounds for musical productions and films</li>
						  <li>Learn about major and minor scales, chords and rhythm</li>
						  <li>Learn about different ragas, taal, alankar and thaats</li>
						  <li>Learn classical, jazz, blues, pop and contemporary music</li>
					</ul>
					</div>
				</div>
			</div>
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Learn, Execute, and Create the next Award-winning track!</p>
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma in Music Production</a>
			  </li>
		</ul>
				...
				<div class="accordion" id="accordionExample">
					<div class="card">
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
                                   <li>Music and Sound Theory - I</li>
								  <li>Recording, Mixing and Mastering - I</li>
								  <li>Indian Music - I</li>
								  <li>Western Music - I</li>
								  <li>Individual Music Video Project (Choice-Based Vocal / Instrument)</li>
					...
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Music and Sound Theory - II</li>
									  <li>Recording, Mixing and Mastering - II</li>
									  <li>Indian Music - II</li>
									  <li>Western Music - II</li>
									  <li>Music Video - Orchestral Music Instrumental</li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Diploma in Music Production | 1 year</span></p>
					<ul>
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">Our state-of-the-art infrastructure boasts industry-relevant advanced studios, labs, high-end equipment, the latest iMacs and Windows systems
			with relevant software, etc., to ensure that students get a first-hand understanding of industry concepts and work.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-5">
				<div class="add-info">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						 <li>Digital Audio Workstations (DAWs) like FL Studio, Logic Pro, and Ableton Live</li>
						  <li>Sound design and synthesis</li>
						  <li>Mixing and mastering</li>
						  <li>Music theory and composition</li>
						  <li>Studio recording technique</li>
						  <li>Music marketing and distribution</li>
					</ul>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				<div class="card-header" data-toggle="collapse" data-target="#collapseOne223" aria-expanded="true">     
					<span class="title">1. What is the duration of the Diploma in Music Production course at AAFT?</span>
					<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
				</div>
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Diploma in Music Production is a 1-year intensive program designed to equip students with both creative and technical skills in audio production.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. What kind of hands-on training will I receive?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>You will get access to professional studios and equipment, work on real-time projects, and collaborate with singers, filmmakers, and DJs to produce full-length tracks and remixes.</li>
					</ul>
				</div>
			</div>
		</div>
