...
<title>Photography Bachelor Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>B.A. in Photography Program| AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Bachelor of Arts in Photography">Bachelor of Arts in Photography</option>';				
...
<section class="program1">
	<div class="container">
		<div class="about">
			...
			<p>At the School of Still Photography, with our B.A in Photography, this comprehensive undergraduate program is your gateway to becoming part of the elite 1% in the photography world. Designed for passionate individuals ready to capture compelling stories through their lenses, our program stands out among the best photography courses available. Our B.A in Photography combines the theoretical foundations of visual arts with extensive practical experience, making it the perfect choice for both beginners and those with some photography background. As a leading photography and videography course provider, we ensure that our students gain hands-on experience in professional-grade studios and learn from renowned photographers and videographers.</p>
		</div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>B.A. in Photography Program | 3 years</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for a Master Degree or a Diploma Program</li>
		...
		<div class="row">
			<div class="col-sm-7">
					...
					<div class="row">
						<div class="col-sm-6">
							<ul>
								<li>Candidates must have a 10 + 2 from a recognized board</li>
							</ul>
						</div>
						<div class="col-sm-6">
							<ul>
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor Degree Program in Photography at AAFT University has a duration of three years.</li>
						</ul>
					</div>
				</div>
			</div>
...
<?php include('inc/contact-details-photography1.php'); ?>	
