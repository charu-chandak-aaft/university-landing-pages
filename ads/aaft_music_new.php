...
<title>Music colleges in India | AAFT University</title>
<meta name="description" content="Explore top music education at one of the leading music colleges in India with AAFT University, offering expert training in vocals, instruments, and music production.">
  <meta name="keywords" content="Music colleges in India">
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/music-v2/music-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: cover;}
	...
	.banner-area .right-area{padding:20px;	background: #ffffff21;border-radius: 10px; backdrop-filter: blur(10px);}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/music-v2/music-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Music Programs| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - August 2025 Batch</p>
					</div>
					<p class="hr3">Excel as a Music Artist with AAFT University's Music Courses</p>
					<h3>4-Year on-campus program for August 2025 Batch at AAFT University</h3>
				</div>
			</div>
		...
		<div class="duration-content">
			<div class="row notice1">
				<div class="col-sm-2 col-6">
					<div class="item1"><h5>Duration</h5><p>2/4 Years</p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="program1">
	<div class="container">
		<div class="progList mb-5">
			<div class="row">
				<div class="col-sm-5">
					...
					<ul>
						<li>Bachelor of Performing Arts (Specialization in Music) - 4 years</li>
						<li>Master of Performing Arts (Specialization in Music) - 2 years</li>
		...
		<div class="about">
			<h2>About the AAFT School of Music</h2>
			<p>Considered among the best music schools in India, AAFT provides an apt platform for music lovers to nurture their skills and build knowledge of the music industry. We are dedicated to providing students with first-hand exposure to industry operations through industry visits, live projects, master classes, and other practical-based teaching methodologies.</p>
		</div>
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Mix, Master, and Produce the next Award-winning music!</p>
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2a" aria-expanded="true">     
							<span class="title">Master the Music Production Techniques From all Aspects</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential music topics such as understanding the mix & mastering techniques, Music Production, Raagas, Taalas, and whatnot.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Music programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in Music Production, Specialization Degree in Music.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We provide real-world examples of the Music Industry and how it runs by letting them focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>Our Music programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the Music Production Techniques From all Aspects</p>
					<p class="c_dtl">We offer a variety of courses that cover essential music topics such as understanding the mix & mastering techniques, Music Production, Raagas, Taalas, and whatnot.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Music programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in Music Production, Specialization Degree in Music.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Hands-on Equipments Learning</p>
					<p class="c_dtl">We provide real-world examples of the Music Industry and how it runs by letting them focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Win-Win! Collaboration and Communication</p>
					<p class="c_dtl">Our Music programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Music Programs | 2/4 years</span></p>
					<ul>
						...
						<li>Get placed at top production companies in the Music Industry</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row mb-3">
			<div class="col-sm-3 col-12 img-box mb-4">
				<img alt="image" loading="lazy" class="img-fluid" src="assets/img/dean/nikkhil-beri.webp"
					style="color: transparent;border-left: 4px solid #ed4c38" />
			</div>
			<div class="col-sm-9 col-12 content">
				<h5>Nikkhil Beri</h5>
				<p>A Grammy Award winner, Mr. Beri is a trailblazer in the global music industry, celebrated for his
					innovative artistry and groundbreaking productions that deeply resonate with audiences. Known for
					his intricate compositions and technically brilliant work, he has consistently pushed the boundaries
					of music production.</p>
				<p>Beginning his journey as a sound engineer, Mr. Beri has collaborated with a diverse array of artists
					across genres, including folk, spiritual, pop, and acoustic music. His remarkable portfolio includes
					global tours, mixing for Grammy-winning acts, films, and both emerging and established musicians. As
					Industry Dean of AAFT’s School of Music, Mr. Beri’s expertise will be instrumental in guiding
					students and helping them explore the transformative power of music. His mentorship will inspire the
					next generation of musicians and producers, shaping the future of the global music community.</p>
			</div>
		</div>
	</div>
</section>	
		...
		<div class="swiper learner">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/music-v2/apoorba.webp" alt="">
							<div class="text-holder">
								<p class="nm">Mr. Apoorba Chakraborty</p>
								<p class="des">HOD</p>
								<p class="dtls">He is a highly accomplished Hindustani classical vocalist and academician with over 10 years of experience in the field. He holds a Master's degree and qualified for the National Eligibility Test for Lectureships conducted by the University Grants Commission. With an impressive track record of performances on Prasar Bharati Doordarshan and representing VisvaBharati University in Deoghar Pustak Mela.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/music-v2/chandan.webp" alt="">
						<div class="text-holder">
							<p class="nm">Dr. Chandan Singh</p>
							<p class="des">Asst. Professor</p>
							<p class="dtls">He is a professional Kathak dancer from the Lucknow Gharana, and with a mastery of bhav, expressions, and layakari in tatkar, he has showcased his talent at various prestigious dance festivals in India. Dr. Chandan Singh is a true representation of the grace and elegance of Indian classical dance. Presently, he is associated with the School of Performing Arts as an Assistant professor. </p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/music-v2/amit.webp" alt="">
							<div class="text-holder">
								<p class="nm">Mr. Amit Das</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is a seasoned musician with 14 years of professional experience, having worked with legends like Ustad Zakir Hussain and Pandit Kumar Bose. He has also taught at prestigious music schools. Currently, he is an Assistant Professor at AAFT University's School of Performing Arts. He is the coordinator of the AAFT Musical Band ZENITH." </p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/music-v2/suraj.webp" alt="">
							<div class="text-holder">
								<p class="nm">Mr. Suraj Randhawa</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is an Indian Idol 3 contestant (theater rounds) and winner of many competitions, having trained under renowned musicians in Mumbai. He did jingles for popular TV shows and music channels and learned music production from renowned producers to explore the magnificent music industry. Currently, he is associated with the School of Performing Arts as an assistant professor.</p>
		...
		<div class="swiper why">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/music-v2/virat.webp" alt="">
							<div class="text-holder">
								<p class="nm">Virat Jain</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“It was at AAFT that I discovered the freedom to soar high. Pursuing my bachelor's degree here, I was impressed by the fully practical curriculum that enabled me to apply my learning in real-life situations. </p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/music-v2/dev.webp" alt="">
							<div class="text-holder">
								<p class="nm">Dev Singh</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">AAFT has imparted upon me an invaluable lesson: Life is full of liveliness and bliss. My time at the campus allowed me to engage with fellow students through various co-curricular groups where we could explore our shared interests and ideas.</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/music-v2/prince.webp" alt="">
							<div class="text-holder">
								<p class="nm">Prince Yadav</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">Being a part of AAFT is truly an honor. The cooperative and well-educated faculty and professors have provided me with invaluable guidance and support throughout my academic journey.</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/music-v2/chavi.webp" alt="">
							<div class="text-holder">
								<p class="nm">Chavi Srivastava</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">Thanks to ASMS, I have had an outstanding opportunity to showcase my skills and gain valuable exposure. The faculty members have been incredibly cooperative, affording me numerous opportunities to perform in various events. </p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Music is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for music, thereby creating a cohort of promising future leaders.</p>
		<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor Degree Program in Music at AAFT University has a duration of four years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Bachelor of Performing Arts (Specialization in Music) program at AAFT University is a minimum of 50% marks in 10+2 in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Graduates of the Music Degree Program at AAFT University have various career opportunities in fields such as Singer, Songwriter, Composer, Conductor, and Music Teacher.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Music Degree program without a Music background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Music Degree program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of music principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-music1.php'); ?>	
