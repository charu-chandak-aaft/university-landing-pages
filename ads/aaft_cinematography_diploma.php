...
<title>Diploma Cinematography Programme | AAFT University</title>
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/cinema-v1/cinematography_desk.webp"); background-repeat: no-repeat; background-position: top; background-size: cover;}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/cinema-v1/cinematography_mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>Diploma in Camera & Lighting Techniques | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - January 2026 Batch</p>
					</div>
					<p class="hr3">International Affiliations with The Lee Strasberg Theatre & Film Institute, New York</p>
					<h3>On-campus programs for January 2026 Batch at AAFT University</h3>
				</div>
			</div>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Diploma in Camera & Lighting Techniques">Diploma in Camera & Lighting Techniques</option>';				
...
<section class="program1">
	<div class="container">
		<div class="about">
			...
			<p>From the art of acting, where you will breathe life into characters, to the intricate craft of directing and guiding narratives with vision and creativity, the School of Cinema at AAFT ensures you master every aspect of the cinematic spectrum. Our state-of-the-art facilities, including a mini film training studio, post-production lab, screening theater, Mini TV training studio, production studio, and shooting floors, enable our students to gain hands-on experience and develop a deep understanding of filmmaking. School of Cinema takes a hands-on approach to help students understand methodologies like directing, camera operation, photo direction, art direction, sound design, and editing. 
</p>
		</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								<p class="top-title">Get Trained by Veterans</p>
								<p>World-class faculties with real-world experience</p>
							</div>
						</div>	
						<div class="brdr"></div>
					</div>
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Easy financing options available </p>
							</div>
						</div>
						<div class="brdr"></div>
					</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Cinematography experience to fit your career goals</p>
							</div>
						</div>
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Make your own short films & documentaries</li>
						  <li>Film shoot and production house visits</li>
						  <li>Learn from national & internationally renowned veterans</li>
						  <li>Learn to build your own portfolio</li>
					</ul>
					</div>
				</div>
			</div>
...
<section class="excellence">
	<div class="container">
		...
		<p>Our Cinematography program is accredited by prestigious organizations, ensuring the highest standards of quality and value in business education.</p>
		<div class="row">
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma in Camera & Lighting Techniques</a>
			  </li>
		</ul>
				...
				<div class="accordion" id="accordionExample2">
					<div class="card">
						...
						<div id="collapseOne2" class="collapse show" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>Cinematography I</li>
									<li>Continuity Film</li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Diploma in Camera & Lighting Techniques Program | 1 year</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for Bachelor's or Master's Program</li>
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="slide-box">
						...
						<p class="bot-txt">“The environment provided by AAFT is extremely helpful for learning and exposure. The faculties and staff cooperate and support us at every step, helping us achieve more. Opportunities to perform in events are always provided to us which help us grow as an artist.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
		...
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for cinema, thereby creating a cohort of promising future leaders.</p>
			...
			<div class="col-sm-7">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ul>
								<li>Candidates must have a minimum of 50% marks in aggerate in graduation (45% for reserved categories)</li>
							</ul>
						</div>
						</div>
						<div class="row">
						<div class="col-sm-6">
							<ul>
								<li>Candidates need to cear the AART Global Entrance Tect (GET)</li>
							</ul>
						</div>
						<div class="col-sm-6">
							<ul>
								<li>Candidates with valid score of (50 percentile) from any aptitude test such as CAT/GMAT/GRE</li>
							</ul>
						</div>
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>A Diploma in Camera and Lighting Techniques program at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Cinematography Diploma program without a cinema background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Cinematography Diploma program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of cinematic principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-cinemanew44.php'); ?>	
