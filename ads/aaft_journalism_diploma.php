...
<title>Journalism Diploma Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Journalism | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - January 2026 Batch</p>
					</div>
					<p class="hr3">Join the elite community of Journalist</p>
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About School of Journalism and Mass Communication</h2>
				...
				<div class="accordion" id="accordionExample">
					<div class="card">
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
                                   <li>Acting Skills and Presentation</li>
									  <li>Introduction to Print Media</li>
					...
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									 <li>Introduction to Still Photography</li>
									  <li>Study of Radio & TV Production</li>
									  <li>Concept and Process of Advertising</li>
...
<section class="instructor-sec">
	<div class="container">
		...
		<p class="s_hd">Our state-of-the-art infrastructure boasts industry-relevant advanced studios, labs, high-end equipment, the latest I-Macs and windows systems with relevant software, etc., to ensure that students get a first-hand understanding of industry concepts and work.</p>
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Reporter</li>
						  ...
						  <li>News Reporter</li>
						  <li>Script Writer</li>
						  <li>Assistant Director (For News and Programme)</li>
						  <li>TV News Anchor</li>
						  <li>Copy-Editor</li>
						  <li>Reporter/Stringer</li>
					</ul>
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>A Diploma in Journalism program at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
