...
<head>
	...
	<title>AAFT University BBA Degree Program</title>
	...
	<script type="text/javascript">
		...
		var engageName = "6483189d1b4ad9cdc19701f4";
		function setup() {
	...
	<style>
		...
		.iticks-modal-close:focus,
		.iticks-modal-close:hover {
			color: #bbb;
