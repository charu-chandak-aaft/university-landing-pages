...
<title>Diploma in Science in Nutrition & Dietetics Program | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>Diploma in Nutrition & Dietetics Program | AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Diploma in Nutrition & Dietetics">Diploma in Nutrition & Dietetics</option>';				
	...
	<div class="container">
		<div class="duration-content">
			<div class="row notice1">
				...
				<div class="col-sm-2 col-6">
					<div class="item4"><h5>Easy Education Loan</h5><p>Loan Assistance Available</p></div>
				</div>
				<div class="col-sm-2 col-6">
		...
		<div class="progList mb-5">
			<div class="row">
				<div class="col-sm-12">
					...
					<ul>
						<li>Diploma in Nutrition & Dietetics </li>
				...
				<div class="col-sm-6">
					<div class="card">
						...
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential Nutrition & Dietetics topics such as the Importance of Cooking & effect of heat on food, uses of food with their composition and nutritive value, and many more.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Nutrition & Dietetics programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in B.Sc. in Nutrition & Dietetics and M.Sc. in Nutrition & Dietetics.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">We offer a variety of courses that cover essential Nutrition & Dietetics topics such as the Importance of Cooking & effect of heat on food, uses of food with their composition and nutritive value, and many more.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Nutrition & Dietetics programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in B.Sc. in Nutrition & Dietetics and M.Sc. in Nutrition & Dietetics.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
...
<section class="syllabus">
	<div class="container">
		...
		<p class="shd">Explore the roadmap to success with our comprehensive learning objectives, carefully crafted to guide you toward mastery.</p>
		<div class="bbttnn">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma in Nutrition & Dietetics</a>
			  </li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Nutrition & Dietetics Programs | 1 year</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends</li>
						<li>Additionally, you can apply for a  Bachelor Degree, or Master's Degree</li>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				<div class="card-header" data-toggle="collapse" data-target="#collapseOne223" aria-expanded="true">     
					<span class="title">1. What is the duration of the Diploma in Nutrition Programme?</span>
					<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
				</div>
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The duration of the Diploma Program in Nutrition & Dietetics at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>he eligibility criteria for the Diploma Program in Nutrition & Dietetics at AAFT University is a minimum of 50% of marks in 10+2 in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Nutrition & Dietetics Diploma program without a Nutritionist background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Nutrition & Dietetics Diploma program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of Nutrition & Dietetics principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-health4.php'); ?>	
