...
<title>Diploma Acting Programme | AAFT University</title>
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/cinema-v1/acting_banner_desk.webp"); background-repeat: no-repeat; background-position: top; background-size: cover;}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/cinema-v1/acting_banner_mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>Diploma in Acting for Film & TV | AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Diploma in Acting">Diploma in Acting</option>';				
...
<section class="program1">
	<div class="container">
		<div class="about">
			...
			<p>At the AAFT School of Cinema, we specialize in turning passion into expertise with our Diploma in Acting program. Our program is designed for passionate individuals aiming for the pinnacle of success in the acting world. As a renowned acting institute, we offer specialized drama courses and comprehensive training, positioning us among the best acting schools and acting colleges. Our commitment to excellence ensures you gain practical experience in acting, making us one of the most sought-after acting academies. Whether you're interested in drama, seeking top acting colleges, or aspiring to be part of prestigious acting schools, AAFT provides the perfect platform to refine your skills and launch a successful acting career.</p>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Acting experience to fit your career goals</p>
							</div>
						</div>
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma in Acting for Film & TV</a>
			  </li>
		</ul>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Diploma in Acting for Film & TV Program | 1 year</span></p>
					<ul>
		...
		<div class="row">
			...
			<div class="col-sm-5">
				<div class="add-info">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Acting in Films and Television</li>
						<li>Theater Acting</li>
						<li>Commercial Advertisements</li>
						<li>Voice Over Artist</li>
						<li>Radio and Podcasting </li>
						<li>Casting and Production Assistance</li>
					</ul>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Diploma Program in Acting at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Acting Diploma program without a cinema background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Acting Diploma program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of cinematic principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-cinemanew4.php'); ?>	
