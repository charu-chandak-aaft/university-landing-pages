...
<head>
	...
	<title>Animation Bachelor Programme | AAFT University</title>
...
<body>
	...
	<style>
		...
		.banner-area {
			...
			margin-top: 70px;
			background-image: url("assets/img/animation-v1/animation-banner-desk.webp");
		...
		option {
			color: #b3b3b3 !important;
			background-color: rgba(59, 59, 59, 0.90) !important;
		}
		...
		@media only screen and (max-width: 600px) {
			...
			.banner-area {
				...
				color: #fff;
				padding: 100px 0px;
				background-image: url("assets/img/animation-v1/animation-banner-mob.webp");
				background-repeat: no-repeat;
			...
			<div class="row b-sec">
				<div class="col-sm-6">
					<div class="left-area">
						...
						<h1>B.Sc. in Animation & VFX Program | AAFT University, Raipur</h1>
						<div class="hr2">
							<p>Enroll for - July 2025 Batch</p>
						</div>
						<p class="hr3">Join the elite community of Animators and VFX artists</p>
						<h3>On-campus program for July 2025 Batch at AAFT University</h3>
					</div>
				</div>
				<div class="col-sm-2 hide1366"></div>
				<div class="col-sm-4">
					<div id="enquire" style="height:30px; margin-bottom:40px;"></div>
					<div class="right-area">
						<hr class="d-block d-sm-none" />
						<?php
						$pageOption = "Animation";
						$schoolOption = "School of Animation";
						$courseOption = '<option value="Bachelor of Science in Animation & VFX">Bachelor Of Science in Animation & VFX</option>';
	...
	<style>
		...
		@media only screen and (max-width: 600px) {
			.duration1 {
				margin-top: 0px;
				padding: 10px;
				background: linear-gradient(180deg, rgba(0, 0, 0, 1) 0%, rgba(255, 245, 242, 1) 50%, rgba(255, 245, 242, 1) 100%);
				height: 250px;
				position: relative;
				box-shadow: none;
			}

			.duration1 .duration-content {
	...
	<style>
		...
		.program1 .progList {
			box-shadow: 0px 10px 10px #00000014 !important;
			padding: 20px;
		}
	</style>
	...
	<section class="program1">
		<div class="container">
			<div class="about">
				...
				<p>The AAFT School of Animation offers top-tier animation courses, including VFX and animation courses, designed to impart practical and industry-relevant knowledge. Our curriculum, curated by industry experts, encompasses animation and design courses, ensuring that students receive the best animation course experience. Through hands-on projects and assignments, students develop a robust portfolio, making our 3D animation courses highly recommended for aspiring professionals in the field of animation, VFX, game design, and development.</p>
			</div>
	...
	<style>
		...
		.course-info .info-top {
			display: flex;
			align-items: center;
		}

		.course-info {
			background-image: url("assets/img/mba-v2/shape1.png"), url("assets/img/mba-v2/shape2.png");
	...
	<style>
		...
		.advantage .adv-grp {
			box-shadow: 0px 10px 40px #262D7614;
			border-radius: 10px;
		...
		.advantage .adv-grp img {
			display: none;
			margin-bottom: 15px;
		}

		.advantage .adv-grp .adv-p1 {
			margin-bottom: 0px;
			font-weight: 600;
			font-size: 20px;
			margin-bottom: 10px;
...
-->
	...
	<style>
		...
		.syllabus .card-header:not(.collapsed) .rotate-icon {
		...
		.syllabus .accordion>.card>.card-header {
			position: relative;
			background-color: rgb(0 0 0 / 0%);
		}

		.syllabus .accordion>.card>.card-header p {
			margin-top: 10px;
			margin-bottom: 0px;
			color: #a3a3a3;
			font-size: 14px;
		...
		.syllabus .accordion>.card>.card-header .title {
			font-weight: 700;
		}

		.syllabus .accordion .card li {
			font-size: 14px;
			color: #434343;
		}

		.syllabus .accordion .card .fas {
			font-size: 14px;
			color: #43434380;
		}
		...
		.syllabus [data-toggle="collapse"] i:before {
			content: "\f068";
		}

		.syllabus [data-toggle="collapse"].collapsed i:before {
			content: "\f067";
		}
		...
		.syllabus .nav-tabs .nav-item.show .nav-link,
		.syllabus .nav-tabs .nav-link.active {
	...
	<section class="syllabus">
		<div class="container">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">B.Sc. in Animation & VFX</a>
				</li>
			</ul>
							...
							<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
								<div class="card-body">
									<ul>
										...
										<li>2D and 3D animation and character design.</li>
						...
						<div class="card">
							...
							<div id="collapseSix" class="collapse" data-parent="#accordionExample">
								<div class="card-body">
									...
									<ul>
										<li>Introduction to the basics of game design.</li>
	...
	<style>
		...
		.certificate-info .cert-bot {
			margin-left: 30px;
		}

		.certificate-info .cert-bot h2 {
			font-size: 24px;
			line-height: 20px;
			margin-bottom: 24px;
		}

		.certificate-info .cert-bot .bot-title2 {
			font-size: 18px;
			margin-bottom: 20px;
		}

		.certificate-info .cert-bot span {
			color: #FF500D;
		}

		.certificate-info .cert-bot li {
			margin-bottom: 20px;
			margin-left: -20px;
			font-size: 14px;
		}

		. .certificate-info .cert-bot ul {
			font-size: 18px;
		}
			...
			<div class="row cert-top">
				...
				<div class="col-sm-5">
					<div class="cert-bot">
						...
						<p class="bot-title2"><span>Bachelor in Animation & VFX Program | 3 years</span></p>
						<ul>
							<li>Curriculum as per the Latest Industry Trends </li>
							<li>Additionally, you can apply for a Diploma or Master's Program</li>
	...
	<style>
		...
		.application-info .cert-bot span {
			color: #FF500D;
		}

		.application-info .grp1 {
			display: flex;
			align-items: flex-start;
		}

		.application-info .cert-bot {
			margin-left: 20px;
			margin-bottom: 10px;
		}

		.application-info .bot-title {
			font-size: 18px;
			font-weight: 600;
			margin-bottom: .5rem;
		}
		...
		.application-info .cert-box {
			position: relative;
		}

		.application-info .pop1 {
			position: absolute;
			bottom: -60px;
			right: -100px;
			width: 190px;
		...
		.application-info .pop1 .ttl1 {
			font-weight: 600;
		}

		.application-info .pop1 .ttl2 {
			color: #454545;
		}

		.application-info .grp1 img {
			padding: 10px;
			background-color: #fff;
			border-radius: 10px;
		}
	...
	<style>
		...
		.instructor-sec img {
			...
			box-shadow: 0 0 0 5px #f9393930;
		}

		.instructor-sec .tutor {
			display: flex;
			justify-content: center;
			margin-top: 115px;
		}

		.instructor-sec .text-holder {
			padding-top: 50px;
		}
...
<section class="industry-dean py-3">
	...
	<style>
		...
		.placement-sec1 .placement-grid {
			display: grid;
			grid-template-columns: repeat(8, 1fr);
			grid-gap: 30px;
		}

		.placement-sec1 .placement-grid .circle {
			/*filter: grayscale(1);*/
		}

		.placement-sec1 .placement-grid .circle img {
	...
	<style>
		...
		.who-can .add-info span {
			color: #000;
			font-weight: normal;
			margin-right: 10px;
		}

		.who-can .add-info .grid-item {
			margin-bottom: 10px;
		}
		...
		.who-can .info-555 li {
			background: url(assets/img/mba-v2/check.webp) no-repeat left top;
			padding-left: 30px;
	...
	<style>
		...
		.faq-sec .card-header:not(.collapsed) .rotate-icon {
			transform: rotate(180deg);
		}

		.faq-sec [data-toggle="collapse"] i:before {
			content: "\f068";
		}

		.faq-sec [data-toggle="collapse"].collapsed i:before {
			content: "\f067";
		}
			...
			<div class="accordion" id="accordionExample223">
				<div class="card">
					...
					<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
						<div class="card-body">
							<ul>
								<li>The Bachelor's Degree Program in Animation & VFX at AAFT University has a duration of 3 years.</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="card">
					...
					<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
						<div class="card-body">
							<ul>
								<li>The eligibility criteria for the Bachelor's Degree program is a minimum of 50% of marks in 10+2 in any stream from a recognized board.</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
						<span class="title">4. Can I pursue an Animation & VFX Degree program without a background or degree in Animation?</span>
						<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
					</div>
					<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
						<div class="card-body">
							<ul>
								<li>Yes, students from any academic background can pursue the Animation & VFX Degree program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of animation & VFX principles, and students will learn essential skills from scratch.</li>
							</ul>
						</div>
					</div>
				</div>
