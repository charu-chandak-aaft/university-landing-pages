		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Animation & VFX | AAFT University, Raipur</h1>
					<div class="hr2">
	...
	<div class="container">
		<div class="duration-content">
			<div class="row notice1">
				...
				<div class="col-sm-2 col-6">
					<div class="item4"><h5>Loan Options</h5><p>Available </p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About School of Animation and VFX</h2>
			<p>Learn to bring the dream characters to life with a range of 2D and 3D animation and VFX techniques. At AAFT, School of Animation, we offer a wide variety of degree and diploma courses in 2D/3D animation, VFX, game Design, and Development with a blend of practical and theoretical approaches. At AAFT School of Animation, students will learn to bring the characters and stories to life with a range of 2D and 3D animation and VFX techniques. Students will be equipped with the skills, knowledge, and technical training required to make a smooth transition to the field.</p>
		</div>
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
								  ...
								  <li>Fundamentals of Cinematography &amp; Filmmaking</li>
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									  ...
									  <li>Fundamentals of 3D (Maya)</li>
									  <li>Digital Composition Nuke</li>
									  <li>Motion Graphics</li>
									  <li>Video Editing</li>
									  <li>Project Portfolio / Internship</li>
	...
	<div class="container">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-9 col-12 content">
				...
				<p>Charuvi P. Agrawal, an acclaimed filmmaker, digital artist, and sculptor, joins AAFT University as a prominent figure in animation and digital art. Renowned for her innovative works like the critically acclaimed Shri Hanuman Chalisa and the co-creation of Legend of Hanuman on Disney+ Hotstar, she has significantly impacted the Indian OTT landscape. Her artistic journey includes pioneering works in miniatures, her signature 'claytronics,' and large installations, with exhibitions at prestigious venues such as the National Gallery of Modern Art in Delhi and Mumbai. Her most recent creation, Lumena, will travel across four continents, showcasing contemporary Indian art. With two Limca Book of Records and a leadership role as President of the AVGC Task Force at the Ph.D. Chambers of Commerce, Charuvi's work continues to inspire and innovate. At AAFT University, her role as Industry Dean will guide students to explore limitless possibilities in animation and digital art.</p>
			</div>
		</div>
	</div>
</section>
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Compositing Artist</li>
						  ...
						  <li>Match Move Artist</li>
						  <li>3D Animator</li>
						  <li>Roto Artist</li>
						  <li>2D Paint Artist</li>
						  <li>3D Modeler and Texturing Artist</li>
						  <li>3D Lighting and Rendering Artist</li>
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Diploma in Animation and VFX program at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
