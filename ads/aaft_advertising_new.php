...
<title>Advertising,PR & Events | AAFT University</title>
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/advertising-v1/advertising-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: contain;}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/advertising-v1/advertising-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: contain;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Advertising & PR Programs|AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - August 2025 Batch</p>
					</div>
					<p class="hr3">Become a Branding Expert with Advertising Courses</p>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					<?php
					$pageOption="PR and Events";
					$schoolOption="School of PR and Events";
					$courseOption= '<option value="Bachelor of Arts in Event Management">Bachelor of Arts in Event Management</option><option value="Master of Arts in PR & Events">Master of Arts in PR & Events</option><option value="PG Diploma in Advertising & Brand Communication">PG Diploma in Advertising & Brand Communication</option><option value="Diploma in PR & Events">Diploma in PR & Events</option><option value="Diploma in Event Management">Diploma in Event Management</option>';				
...
<section class="program1">
	<div class="container">
		<div class="progList mb-5">
			<div class="row">
				<div class="col-sm-5">
					...
					<ul>
						<li>Bachelor of Arts in Event Management</li>
						<li>Master of Arts in PR & Events</li>
					</ul>
				</div>
				...
				<div class="col-sm-5">
					...
					<ul>
						<li>PG Diploma in Advertising & Brand Communication</li>
		...
		<div class="about">
			<h2>About the AAFT School of Advertising, PR & Events</h2>
			<p>AAFT is dedicated to providing quality education in the fields of advertising, branding, communications, and events through its high-end infrastructure and hands-on training modules. The focus is on imparting practical exposure through an in-house ad agency, corporate visits, and special workshops via industry experts, which together help the students gain a deep understanding of the industry's operations and trends.</p>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Advertising & PR experience to fit your career goals</p>
							</div>
						</div>
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Create, Run, and Succeed with Your PR Campaign Techniques</p>
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2a" aria-expanded="true">     
							<span class="title">Master the Advertising & PR skills From all Aspects</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential advertising topics such as ad films, posters, campaigns from scratch, and whatnot.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Advertising & PR programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in M.A. in PR & Events , PG Diploma in Advertising & Brand Communication.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We provide real-world examples of the Advertising Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>Our Advertising & PR programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the Advertising & PR skills From all Aspects</p>
					<p class="c_dtl">We offer a variety of courses that cover essential advertising topics such as ad films, posters, campaigns from scratch, and whatnot.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Advertising & PR programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in M.A. in PR & Events , PG Diploma in Advertising & Brand Communication.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Hands-on Equipments Learning</p>
					<p class="c_dtl">We provide real-world examples of the Advertising Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Win-Win! Collaboration and Communication</p>
					<p class="c_dtl">Our Advertising & PR programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
...
<section class="syllabus">
	<div class="container">
		...
		<div class="bbttnn">
			<div class="btn11">Master classes & Workshops: <span class="red"> 6+ </span> <span class="d-sm-block d-none"> | </span></div> 
			<div class="btn11">Industry Visits: <span class="red"> 6+ </span> <span class="d-sm-block d-none"> | </span></div>
			<div class="btn11">Celebrity Interactions: <span class="red"> 3+ </span> <span class="d-sm-block d-none"> | </span></div>
			<div class="btn11">Projects: <span class="red"> 2 </span></div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Advertising & PR Programs | 2/3 years</span></p>
					<ul>
						...
						<li>Get placed at top production companies in the Advertising Industry </li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row mb-3">
			<div class="col-sm-3 col-12 img-box mb-4">
				<img alt="image" loading="lazy" class="img-fluid" src="assets/img/dean/prahlad-kakkar.webp"
					style="color: transparent;border-left: 4px solid #ed4c38" />
			</div>
			<div class="col-sm-9 col-12 content">
				<h5>Prahlad Kakkar</h5>
				<p>Prahlad Kakkar is an Indian ad film director, best known for his work on a Pepsi TV commercial with
					Amitabh Bachchan and Sachin Tendulkar, has joined AAFT University as the Industry Dean of the School
					of Advertising, PR & Events. Prahlad has won several awards for technical excellence, Innovation and
					creativity in advertising over the years in India. His production house, Genesis, won both gold and
					silver awards including campaign of the year for the Pepsi commercials at AAAI. Commercials directed
					by Prahlad have also been nominated for Lions at Cannes. Prahlad Kakkar has earned himself a
					Lifetime Achievement Award by the IAAFA and made Genesis the top Production House for two
					consecutive seasons. He has helped create campaigns like "Yehi Hai Right Choice Baby! Aha!" Pepsi
					Ad, "The Zing Thing" Gold Spot Ad, "2 minutes!" Noodles Ad for Maggi, "Ting Ting Ti Ting" Britannia
					Biscuits Football Ad, "Zor ka Jhatka" for Limca and "It's different" for Maggi Ketchup.</p>
			</div>
		</div>
	</div>
</section>	
		...
		<div class="swiper learner">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/advertising-v1/shweta.webp" alt="">
							<div class="text-holder">
								<p class="nm">Dr. Shweta Bajaj</p>
								<p class="des">HOD</p>
								<p class="dtls">She is an experienced academician and Head of Department at the School of Advertising, PR, and Events. She specializes in event planning, HR management, business research, and marketing. She has a Ph.D. in Total Quality Management.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/advertising-v1/akriti.webp" alt="">
						<div class="text-holder">
							<p class="nm">Akriti Upadhyay</p>
							<p class="des">Asst. Professor</p>
							<p class="dtls">She is a self-motivated, two-time UGC-NET-qualified Assistant Professor with a postgraduate degree in Journalism. She is a gold medalist in her UG and PG. Her aim is to leverage her knowledge and skills to contribute to the growth of institutions and students.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/advertising-v1/rashmi.webp" alt="">
							<div class="text-holder">
								<p class="nm">Rashmi Priya</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">She is a skilled professional with 10 years of professional experience. Her expertise lies in news editing, PR, advertising, events, and marketing. She holds an MJMC, an MBA, and is twice UGC NET qualified in MJMC.</p>
		...
		<div class="swiper why">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/advertising-v1/arpita.webp" alt="">
							<div class="text-holder">
								<p class="nm">Arpita Joshi</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“I am deeply grateful to the faculty and staff for providing me with the necessary resources and guidance to excel in my career. Over the past two years, I have experienced significant personal and professional growth, which has been invaluable to me. ”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/advertising-v1/pranjal.webp" alt="">
							<div class="text-holder">
								<p class="nm">Pranjal Soni</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“AAFT gave me such unforgettable memories. I took full advantage of my learning there. Traveling to lots of places for practicals and having new experiences was a great part of my studies. I explored my talent here, and AAFT helped me enhance my skills as well.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/advertising-v1/muskan.webp" alt="">
							<div class="text-holder">
								<p class="nm">Muskaan Khandelwal </p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“My overall experience with AAFT has been awesome. AAFT provides us with diverse opportunities to enhance our personalities and helps us develop a good career in our field. The special key to AAFT is the faculty over there, which is always ready to help and guide you. ”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/advertising-v1/tanya.webp" alt="">
							<div class="text-holder">
								<p class="nm">Tanya Shilpa Chauhan</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“It was an incredible learning experience with all the professors; they are able to make difficult concepts easy to understand. All are always available outside of class to answer all the questions. All are knowledgeable, passionate, and dedicated to helping all the students.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Advertising, PR & Events is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for advertising, thereby creating a cohort of promising future leaders.</p>
		<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor Degree Program in Advertising at AAFT University has a duration of three years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue an Event Management Degree program without an Event or Advertising background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Event Management Degree program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of event principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-events1.php'); ?>	
