...
<title>Animation colleges in India | AAFT University</title>
<meta name="description" content="Step into the world of creativity with AAFT University, one of the premier animation colleges in India offering industry-ready programs in animation and VFX.">
  <meta name="keywords" content="Animation colleges in India">
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Animation & VFX Programs| AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					/* $courseOption= '<option value="Bachelor Of Science in Animation & VFX">Bachelor Of Science in Animation & VFX</option><option value="Master Of Science in Animation & VFX">Master Of Science in Animation & VFX</option><option value="Diploma in Animation & VFX">Diploma in Animation & VFX</ option>';*/
					$courseOption= '<option value="Bachelor Of Science in Animation & VFX">Bachelor Of Science in Animation & VFX</option><option value="Diploma in Animation & VFX">Diploma in Animation & VFX</ option>';	
		...
		<div class="progList mb-5">
			<div class="row">
				<div class="col-sm-5">
					...
					<ul>
						<li>Bachelor Of Science in Animation & VFX</li>
						<li>Master Of Science in Animation & VFX</li>
					</ul>
				</div>
				...
				<div class="col-sm-5">
					...
					<ul>
						<li>Diploma in Animation & VFX</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Animation & VFX Programs | 2/3 years</span></p>
					<ul>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor Degree Program in Animation & VFX at AAFT University has a duration of three years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>After the Animation & VFX Program at AAFT University, students get various career opportunities in fields such as Graphic Designer, VFX Artist, Animator, Concept Artist, Calligrapher, Sketch Artist, and Sculptor.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue an Animation & VFX Degree program without an Animator background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
...
<?php include('inc/contact-details-animation2.php'); ?>	
