...
<title>Diploma Direction Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>Diploma in Direction & Screenplay Writing | AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Diploma in Direction & Screenplay Writing">Diploma in Direction & Screenplay Writing</option>';				
...
<section class="program1">
	<div class="container">
		<div class="about">
			...
			<p>At the AAFT School of Cinema, our Diploma in Direction program transforms your passion for storytelling into directorial expertise. Tailored for those who dream of leading film sets, our curriculum is crafted to meet the demands of the dynamic film industry. As a distinguished film and directing college, we offer a rigorous film director course that ranks us among the elite colleges for film directing. Our commitment to nurturing future leaders in film ensures you receive hands-on training in movie direction, setting us apart as one of the most sought-after institutions for aspiring directors. Whether you're looking to learn movie direction, searching for top film and directing colleges, or aiming to join the ranks of acclaimed directors, AAFT is your gateway to mastering the art and science of film direction.</p>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Direction experience to fit your career goals</p>
							</div>
						</div>
...
<section class="excellence">
	<div class="container">
		...
		<p>Our Acting program is accredited by prestigious organizations, ensuring the highest standards of quality and value in business education.</p>
		<div class="row">
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Diploma in Direction & Screenplay Writing</a>
			  </li>
		</ul>
				...
				<div class="accordion" id="accordionExample2">
					<div class="card">
						...
						<div id="collapseOne2" class="collapse show" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>Introduction to direction & screenplay writing.</li>
					...
					<div class="card">
						...
						<div id="collapseTwo2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>Producing & Directing: Mise-en-scène</li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Diploma in Direction & Screenplay Writing Program | 1 year</span></p>
					<ul>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Diploma Program in Direction & Screenplay Writing at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Diploma program is a 10+2 in any stream from a recognized board.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue a Direction Diploma program without a cinema background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Direction Diploma program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of cinematic principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-cinemanew6.php'); ?>	
