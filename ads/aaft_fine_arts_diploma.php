...
<title>Fine Arts Diploma Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Fine Arts | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - January 2026 Batch</p>
					</div>
					<p class="hr3">Where creativity meets mastery in every stroke.</p>
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About the AAFT School of Photography</h2>
			<p>Paint the canvas of your life and get access to the realm of art with AAFT School of Fine Arts. With this program, students will learn about various art forms like painting, drawing and clay modeling. AAFT has opened doors to the world of art through our Bachelor of Fine Arts program. This program provides a comprehensive understanding of the techniques of painting, clay modeling and drawing. Moreover, it covers topics such as history of art, aesthetics and the concept of visual arts.</p>
		</div>
			...
			<div class="col-sm-4">
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Learn the perfect blend of traditional and modern tools</li>
						  <li>Participate in national and international art shows</li>
						  <li>Access to well-equipped studios, design labs and creative spaces</li>
						  <li>100% Practical Curriculum Approach</li>
						  <li>EDGE and CARE Support for Placement Assistance</li>
					</ul>
					</div>
				</div>
			</div>
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Turn your Talent into Timeless Art</p>
				...
				<div class="accordion" id="accordionExample">
					<div class="card">
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
                                    <li>Foundation of Art : Prehistory of Classical Era</li>
									  <li>Drawing I</li>
									  <li>Chromatics I</li>
									  <li>2D Design</li>
					...
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Cultural Interactions : Middle Ages to Gupta Period</li>
									  <li>Drawing II</li>
									  <li>Chromatics II</li>
	...
	<div class="container">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-9 col-12 content">
				<h5>George Martin</h5>
				<p>George Martin, born in Kerala in 1973, was the first recipient of Art India Magazine's Promising Artist Award in 2005. His works are luscious in colour. His abstract abstractions exuberate copious amounts of energy and are an ultimate representation of modern urban life. Martin's densely populated compositions make him a true artist. His works are displayed in various exhibitions and solo shows including 'Cavities' at Palette Art Gallery, New Delhi, 'Lost Article' at India Habitat Centre, New Delhi in 2007 and 'Footloose of Blue Pencil' at Bombay Art Gallery, Mumbai, 2006. As Industry Dean at AAFT School of Fine Arts, George Martin and his works will help guide students to explore limitless possibilities in visual art.</p>
			</div>
		</div>
	</div>
</section>
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">A Diploma in Fine Arts program at AAFT University has a duration of 1 year.</p>
				<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Visual Artist</li>
						  ...
						  <li>Illustrator</li>
						  <li>Art Director</li>
						  <li>Animator / Multimedia Artist</li>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>A Diploma in Fine Arts program at AAFT University has a duration of 1 year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Diploma program is a minimum of 50% of marks in 10+2 in any stream from a recognized board.
</li>
					</ul>
				</div>
			</div>
