...
<div class="part1 part11" id="part1">
	...
	<img style="width:100%; height:85vh; margin:60px 0;" src="assets/img/banner/cinema-bg-mob.webp">
...
.hero_sec_cinema_new{margin-top:70px;}
...
<section class="hero_sec_cinema_new d-flex align-items-center">
	<div class="container">
		<div class="row d-flex align-items-center">
			<div class="col-lg-8 col-md-8">
				<div class="hero_sec_content">
					<p style="color:#ffe9e8; font-weight: 600; font-size: 25px;">Degree & Diploma Programs</p>
					<h2>'International Affiliations with The Lee Strasberg <br>Theatre & Film Institute, New York'</h2>
...
<section class="white-sec-2" style="padding-bottom: 0; padding:0 0 0 0; background: none;">
	<div class="container">
		<div class="row reverse">
			...
			<div class="col-lg-4 col-md-4">
				<?php
				$pageOption="Film-Making";
				$schoolOption="School of Cinema";
				$courseOption= '<option value="BA in Cinema">BA in Cinema</option><option value="MA in Cinema">MA in Cinema</option><option value="Diploma in Acting">Diploma in Acting</option><option value="Diploma in Direction">Diploma in Direction</option><option value="Diploma in Post Production">Diploma in Post Production</option><option value="Diploma in Cinematography">Diploma in Cinematography</option>';				
		...
		<div class="row">
			<div class="col-sm-8 order-sm-1">
				<div class="body-copy-Black">
					<h2>Our Programs</h2>
					<p>AAFT Film Making Courses are focused on letting the students explore different genres and styles of films, understand the challenges of the contemporary cinema world, and build an artistic and critical approach towards motion pictures. Our courses are curated under the guidance of industry experts and are practical-oriented to ensure students are acquainted with the latest industry knowledge. </p>
				</div>
				<div class="">
					<div class="accordion" id="accordionExample3">
							<div class="card">
								...
								<div id="collapseOne3" class="collapse show" data-parent="#accordionExample3">
									<div class="card-body">
										<div class="year">3/4 year</div> <br>
										<ul>
			...
			<div class="col-sm-8">
				...
				<div class="row holder11">
					...
					<div class="col-sm-6 order-sm-2">
						<img src="assets/img/cinema-v1/course-high3.webp" width="80%" alt="">
					</div>
					<div class="col-sm-6 order-sm-1">
						...
						<ul>
							...
							<li>Visits to Production Houses & Shooting Sets</li>
							<li>International Affiliations with <br>
							The Lee Strasberg Theatre & Film Institute, New York</li>
						</ul>			
					</div>
				</div>
			</div>
				...
				<div class="row holder11">
					...
					<div class="col-sm-8 order-sm-1">
						<video playsinline="playsinline" id="aaft-video" controls width="100%" height="400">
							<source src="https://s3.ap-south-1.amazonaws.com/aaft.com/lp-project-university/SOC-project-video.mp4" type="video/mp4">
						</video>
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				...
				<p class="courseo-txt">The objective of the AAFT filmmaking courses is to enable students to understand the creative aspects of filmmaking such as shaping and controlling artistic facets, script visualization, costume effects, etc. along with imparting in-depth knowledge of technical aspects like understanding various types of shots, camera angles, lighting effects, motion picture formats, etc.</p>
					...
					<div class="featured_box_group">
						<div class="featured_box_list">
							<div class="featured_box">
					          ...
					          <h3>Project 1</h3>
					          <p>Psychophysical exploration On Camera</p>
					        </div>
						</div>
						<div class="featured_box_list">
							<div class="featured_box">
					          <span class="dash"></span>
					          <h3>Project 2</h3>
					          <p>Physical adaptation of Musical narrative on Camera</p>
					        </div>
						</div>
						<div class="featured_box_list">
							<div class="featured_box">
				...
				<div class="how-it-works">
					<div class="row">
						<div class="col-sm-5 imhldr">
							...
							<img class="iiimg" src="assets/img/cinema-v1/cin1.webp" alt="" width="100%">
						</div>	
						<div class="col-sm-7">
							...
							<div class="ct-box1">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/cinema-v1/icon1.webp" alt="">
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/cinema-v1/icon2.webp" alt="">
									</div>
									<div class="col-sm-9 col-9">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/cinema-v1/icon3.webp" alt="">
									</div>
									<div class="col-sm-9 col-9">
					...
					<div class="swiper portfolio">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<img src="assets/img/cinema-v1/cinema-proj1.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								 <img src="assets/img/cinema-v1/cinema-proj2.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								<img src="assets/img/cinema-v1/cinema-proj3.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								<img src="assets/img/cinema-v1/cinema-proj4.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								<img src="assets/img/cinema-v1/cinema-proj5.webp" class="img-fluid" alt="">
							</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					...
					<p>AAFT School of Cinema is equipped with advanced infrastructure facilities through which the students can gain an extensive understanding of how film sets work and how the whole movie-making process takes place. The high-end film studios, Chroma Studios, film screening theatres, sets, etc. at our filmmaking college provide a Skill-Learning opportunity to the students through which they become competent to embark on a professional career in the film & TV industry.</p>
                    ...
                    <p> We have - Film Studios • TV and Film Sets • Chroma Studio • Arri Film Camera • Screening Theatres • Advance Acting Theatre • Tracks-Trolley • Cranes</p>
				...
				<div class="curtain swiper-container">
		            <div class="swiper-wrapper">
		                <div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/cinema-v1/cinema-infra1.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                			<h3><span>Advanced</span> Acting Studios</h3>
		                			<ul>
		                ...
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/cinema-v1/cinema-infra2.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                ...
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/cinema-v1/cinema-infra3.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                ...
		                <div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/cinema-v1/cinema-infra4.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="bod-grid m-t-20">
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/cinema-v1/rahul-rawail.webp" class="img-fluid img-center">
						</div>
						<h3>Rahul Rawail</h3>
					...
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/cinema-v1/madhur.webp" class="img-fluid img-center">
						</div>
						<h3>Madhur Bhandarkar</h3>
						<span>Film Maker</span>
					</div>
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/cinema-v1/anurag.webp" class="img-fluid img-center">
						</div>
					...
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/cinema-v1/sujoy.webp" class="img-fluid img-center">
						</div>
						<h3>Sujoy Ghosh</h3>
						<span>Film Maker</span>
					</div>
					...
					<div class="row">
					    <div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/cinema-v1/santosh-s.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>HOD</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/cinema-v1/ashok-b.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>Assistant Professor</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/cinema-v1/mahender-rao.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>Assistant Professor</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/cinema-v1/birju-raj.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="row">
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/cinema-v1/fiza-dang.webp" class="course-image">
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/cinema-v1/cinema-shamangi.webp" class="course-image">
							<div class="img-content1">
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/cinema-v1/cinema-aviral.webp" class="course-image">
							<div class="img-content1">
								<h5>Aviral Joshi</h5>
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/cinema-v1/cinema-rudra.webp" class="course-image">
							<div class="img-content1">
								<h5>Rudra Bose</h5>
...
<?php include('inc/contact-details-cinema.php'); ?>	
