...
<title>Wellness | AAFT University</title>
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/wellness-v1/wellness-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: contain;}
	...
	.banner-area .right-area{padding:20px;	background: #00000061; border-radius: 10px; backdrop-filter: blur(10px);}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/wellness-v1/wellness-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Nutrition & Dietetics Programs| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - August 2024 Batch</p>
					</div>
					<p class="hr3">Stand among the top 1% Nutritionists & Dietitians</p>
					<h3>On-campus program for August 2024 Batch at AAFT University</h3>
				</div>
			</div>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$schoolOption="School of Nutrition and Dietetics";
					$courseOption= '<option value="Bachelor of Science in Nutrition & Dietetics">Bachelor of Science in Nutrition & Dietetics</option><option value="Master of Science in Nutrition & Dietetics">Master of Science in Nutrition & Dietetics</option><option value="Diploma in Science in Nutrition & Dietetics">Diploma in Science in Nutrition & Dietetics</option>';				
		...
		<div class="progList mb-5">
			<div class="row">
				<div class="col-sm-5">
					...
					<ul>
						<li>Bachelor of Science in Nutrition & Dietetics</li>
				...
				<div class="col-sm-5">
					...
					<ul>
						<li>Diploma in Science in Nutrition & Dietetics</li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Nutrition & Dietetics experience to fit your career goals</p>
							</div>
						</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Nutrition & Dietetics programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in M.Sc. in Nutrition & Dietetics and Diploma in Nutrition & Dietetics.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			...
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Nutrition & Dietetics programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in M.Sc. in Nutrition & Dietetics and Diploma in Nutrition & Dietetics.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Nutrition & Dietetics Programs | 2/3 years</span></p>
					<ul>
						...
						<li>Get placed at top production companies in the Wellness Industry</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="swiper learner">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/wellness-v1/shradha.webp" alt="">
							<div class="text-holder">
								<p class="nm">Dr. Shradha Vaishnav</p>
								<p class="des">HOD</p>
								<p class="dtls">She has done her Ph.D. and masters in Biotechnology. She has published research papers, book chapters, and books. She is currently an HOD in the School of Wellness at AAFT University. She holds keen interest in the field of research.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/wellness-v1/ankita-k.webp" alt="">
						<div class="text-holder">
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/wellness-v1/ankita.webp" alt="">
							<div class="text-holder">
								<p class="nm">Ankita Shrivastava</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">She is an Assistant Professor at AAFT University of Media and Arts, having specialization in Dietetics. She completed her post-graduation in Food Science and Quality Control and worked as an dietitian in various A listed hospitals at Raipur.</p>
		...
		<div class="row">
			...
			<p class="shd">Discover where the success stories began - our alumni are thriving at these top-tier organizations!</p>
				<div class="placement-grid m-t-40">
					...
					<div class="placement-list circle"><img src="assets/img/wellness-v1/amul.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/wellness-v1/britania.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/wellness-v1/cadbury.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/wellness-v1/parle.webp" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</div>
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Wellness is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor Degree Program in Nutrition & Dietetics at AAFT University has a duration of three years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>After the Nutrition & Dietetics Program at AAFT University, students get various career opportunities in fields such as Health Coaching, Sports Nutritionist, Dietitian, Nutritionist, Nutritional Therapist, Animal Nutritionist.</li>
					</ul>
				</div>
			</div>
		</div>
