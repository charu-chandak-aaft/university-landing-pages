...
<div class="part1 part11" id="part1">
	...
	<img style="width:100%; height:85vh; margin:60px 0;" src="assets/img/banner/post-banner-new-mob.webp">
...
<?php include('inc/header-script.php'); ?>
	...
	@media screen and (max-width:480px){
		...
		.students .role-box {margin: 10px !important;}	
		.students .role-box p {font-size: 14px!important;}
		...
		.hero_sec_post_new .align-items-center{margin-top: 200px;}
	...
	@media screen and (max-width:1500px)and (min-width:768px){
		...
		.register-form-home-wrapper {top: 125px!important; position: fixed !important; z-index: 999 !important;}
	}
	...
	{
		.hero_sec_datasciencenew {background-size: cover; background-position: bottom; background-repeat: no-repeat;}	
		.course-orientation .nav-item {width: 30%!important;}
	}
...
.hero_sec_post_new{margin-top:70px;}
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT | School of post production" alt="AAFT | School of post production" class="img-fluid lplogo">
...
<section class="hero_sec_post_new d-flex align-items-center">
	<div class="container">
		<div class="row d-flex align-items-center">
			<div class="col-lg-8 col-md-8">
				<div class="hero_sec_content">
					<p style="color:#ffe9e8; font-weight: 600; font-size: 25px;">Diploma Programs</p>
		...
		<div class="row">
			<div class="col-sm-8 order-sm-1">
				<div class="body-copy-Black">
					<h2>Our Programs</h2>
					<p>AAFT Film & Video Editing Courses provide aspiring students the opportunity to build their career in the domain of Post Production by imparting requisite knowledge and skills to them through comprehensive training modules. These courses are well designed with a core creative and practical proficiency for imparting students the requisite industry knowledge.</p>
				</div>
				<div class="">
			...
			<div class="col-sm-8">
				...
				<div class="row holder11">
					...
					<div class="col-sm-6 order-sm-2">
						<img src="assets/img/postproduction-v1/course-high3.webp" width="80%" alt="">
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				...
				<p class="courseo-txt">This one year intensive programme follows a practice-oriented approach designed to enable students to understand the fundamentals of video editing and students will learn the fundamentals and application of editing for film, television as well as aspects of animation and multimedia. The course is designed to meet the advance and professional level standards of the film industry with an engaging mix of theory and practical’s to develop their skill set and expertise in the field of cinema.</p>
				
				<ul class="nav nav-tabs">
					<li class="nav-item">
						<a class="nav-link">Diploma</a>
					</li>
				</ul>
				...
				<div class="how-it-works">
					<div class="row">
						<div class="col-sm-5 imhldr">
							...
							<img class="iiimg" src="assets/img/postproduction-v1/cin1.webp" alt="" width="100%">
						</div>	
						<div class="col-sm-7">
							...
							<div class="ct-box1">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/postproduction-v1/icon1.webp" alt="">
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/postproduction-v1/icon2.webp" alt="">
									</div>
									<div class="col-sm-9 col-9">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/postproduction-v1/icon3.webp" alt="">
									</div>
									<div class="col-sm-9 col-9">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="placement-grid m-t-40">
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-1.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-2.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-3.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-4.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-5.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-6.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-7.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/postproduction-v1/acting-8.webp" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="row">
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/postproduction-v1/hasleen.webp" class="course-image">
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/postproduction-v1/director-1.webp" class="course-image">
							<div class="img-content">
								<h5>Luv Ranjan</h5>
								<span>Director</span>
							</div>
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/postproduction-v1/director-2.webp" class="course-image">
							<div class="img-content">
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img src="assets/img/postproduction-v1/cinematographer-1.webp" class="course-image">
							<div class="img-content">
					...
					<div class="swiper portfolio">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<img src="assets/img/postproduction-v1/cinema-proj1.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								 <img src="assets/img/postproduction-v1/cinema-proj2.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								<img src="assets/img/postproduction-v1/cinema-proj3.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								<img src="assets/img/postproduction-v1/cinema-proj4.webp" class="img-fluid" alt="">
							</div>
							<div class="swiper-slide">
								<img src="assets/img/postproduction-v1/cinema-proj5.webp" class="img-fluid" alt="">
							</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					...
					<p>AAFT School of Cinema is equipped with high-end editing labs with the latest software and Chroma studios. Our fully-equipped studios with high-end cameras and other equipment provide students an opportunity to face and handle cameras in real-time.</p>
				...
				<div class="curtain swiper-container">
		            <div class="swiper-wrapper">
		                <div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/postproduction-v1/cinema-infra1.webp" class="img-fluid">
		                		</div>
		                ...
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/postproduction-v1/cinema-infra2.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                ...
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/postproduction-v1/cinema-infra3.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                ...
		                <div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/postproduction-v1/cinema-infra4.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="bod-grid m-t-20">
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/postproduction-v1/rahul-rawail.webp" class="img-fluid img-center">
						</div>
						<h3>Rahul Rawail</h3>
					...
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/postproduction-v1/madhur.webp" class="img-fluid img-center">
						</div>
					...
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/postproduction-v1/anurag.webp" class="img-fluid img-center">
						</div>
					...
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/postproduction-v1/sujoy.webp" class="img-fluid img-center">
						</div>
						<h3>Sujoy Ghosh</h3>
						<span>Film Maker</span>
					</div>
					...
					<div class="row">
					    <div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/postproduction-v1/santosh-s.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>HOD</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/postproduction-v1/ashok-b.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>Assistant Professor</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/postproduction-v1/mahender-rao.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>Assistant Professor</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/postproduction-v1/birju-raj.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
...
<?php include('inc/contact-details-post-production.php'); ?>	
