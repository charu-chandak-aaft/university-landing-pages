...
<div class="part1 part11" id="part1">
	...
	<img style="width:100%; height:85vh; margin:60px 0;" src="assets/img/banner/healthnew-hero-banner-mob.webp">
...
<?php include('inc/header-script.php'); ?>
	...
	@media screen and (max-width:480px){
		...
		.hero_sec_healthnew .align-items-center{margin-top: 200px;}
...
.hero_sec_healthnew{margin-top:70px;}
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT | School of wellness" alt="AAFT | School of wellness" class="img-fluid lplogo">
	...
	<div class="container">
		<div class="row reverse">
			...
			<div class="col-lg-4 col-md-4">
				<?php
				$pageOption="Wellness";
				$schoolOption="School of Wellness";
				$courseOption= '<option value="B.Sc in Nutrition and Dietetics">B.Sc in Nutrition and Dietetics</option><option value="M.Sc. in Nutrition and Dietetics">M.Sc. in Nutrition and Dietetics</option><option value="Diploma in Nutrition and Dietetics">Diploma in Nutrition and Dietetics</option>';				
...
<section class="white-sec" style="padding-top: 0;">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					<h1>AAFT Nutrition & Dietetics Courses</h1>
					<p>Delve into the field of food science and learn to apply the principles of devising a perfect diet plan that promotes healthy eating habits by enrolling yourself in the diverse range of nutrition courses offered by AAFT School of Wellness.<br>With our comprehensive programs, you will learn everything you need to know about nutrition, diet and health. Our numerous Indian and international collaborations help the students at the School of Wellness to carve a niche for themselves on a global platform.</p>
				</div>
					...
					<div class="batchbox-list">
						<div class="group88">
							...
							<div class="course-list">
								<p><i class="bi bi-record2"></i>Degree Program (3/2 Years)</p>
								...
								<div id="collapseOne3" class="collapse show" data-parent="#accordionExample3">
									<div class="card-body">
										...
										<ul>
											...
											<li>M.Sc. in Nutrition and Dietetics</li>
			...
			<div class="col-sm-8">
				...
				<div class="row holder11">
					...
					<div class="col-sm-6 order-sm-2">
						<img src="assets/img/health-v1/course-high-health.webp" width="80%" alt="">
					</div>
		...
		<div class="row">
			<div class="col-sm-8 hold22">
				...
				<div class="row holder11">
					...
					<div class="col-sm-8 order-sm-1">
						<video playsinline="playsinline" id="aaft-video" controls width="100%" height="450">
							<source src="https://s3.ap-south-1.amazonaws.com/aaft.com/lp-project-university/FAc+testimonials_Ruchi+Agarwal_Wellness+and+Nutrition+HI+Res.mp4" type="video/mp4">
						</video>
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				...
				<p class="courseo-txt">Our courses allow students to understand the functioning of the wellness industry. The below section highlights the major topics covered in the courses at AAFT.</p>
				...
				<div class="idus-visit m-t-70">
					...
					<div class="featured_box_group">
						...
						<div class="featured_box_list">
							<div class="featured_box">
					          <span class="dash"></span>
					          <h3>Research in Nutritional Science</h3>
					          <p> </p>
					        </div>
						</div>
						<div class="featured_box_list">
				...
				<div class="how-it-works">
					<div class="row">
						<div class="col-sm-5 imhldr">
							...
							<img class="iiimg" src="assets/img/health-v1/health1.webp" alt="" width="100%">
						</div>	
						<div class="col-sm-7">
							...
							<div class="ct-box1">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/health-v1/icon1.webp" alt="">
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/health-v1/icon2.webp" alt="">
									</div>
									<div class="col-sm-9 col-9">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img src="assets/img/health-v1/icon3.webp" alt="">
									</div>
									<div class="col-sm-9 col-9">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="placement-grid m-t-40">
					<div class="placement-list circle"><img src="assets/img/health-v1/health-2.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/health-v1/health-3.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/health-v1/health-4.webp" class="img-fluid"></div>
					<div class="placement-list circle"><img src="assets/img/health-v1/health-5.webp" class="img-fluid"></div>
...
<section class="white-sec-2">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					<h2>What you will   <span>Learn?</h2>
				</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					...
					<p>In terms of the infrastructure, our institute matches international standards. It has air-conditioned classrooms with LCD projectors, and offers hands-on experience to its students through in-house fully-equipped Kitchen lab, Biology Lab, Medical equipments etc.</p>
				...
				<div class="curtain swiper-container">
		            <div class="swiper-wrapper">
		                <!--div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/infra/health-1.jpg" class="img-fluid">
		                		</div>
		                ...
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/health-v1/infra1.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                			
		                			<ul>
										<li>Nutrition labs and kitchen</li>
										<li>Biology lab</li>
										<li>Acupuncture and Acupressure labs</li>
		                ...
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/health-v1/infra2.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                			...
		                			<ul>
										...
										<li>Stadiometer</li>
										<li>Body Composition Analyser</li>
										<li>Caliper</li>
									</ul>
		                		</div>
		                	</div>
		                ...
		                <div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img src="assets/img/health-v1/infra3.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="bod-grid m-t-40">
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/health-v1/abhimanyu.webp" class="img-fluid img-center">
						</div>
						<h3>Abhimanyu Bhati</h3>
						<span>Yoga Expert</span>
					</div>
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/health-v1/ankur.webp" class="img-fluid img-center">
						</div>
						<h3>Ankur Sharma</h3>
					...
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/health-v1/deepti.webp" class="img-fluid img-center">
						</div>
						<h3>Deepti Sherawat</h3>
						<span>Renowned Nutritionist</span>
					</div>
					<div class="bod-list">
						<div class="circle">
							<img src="assets/img/health-v1/rajarshi.webp" class="img-fluid img-center">
						</div>
						<h3>Dr Rajarshi Bhattacharjee</h3>
						<span>Corporate Physician</span>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
					    <div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/health-v1/manish.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>HOD</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/health-v1/shradha.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									...
									<span>Assistant Professor</span>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/health-v1/bhanu.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									<h3>Chef Bhanu</h3>
									<span>Assistant Professor</span>
								</div>
												...
												<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img src="assets/img/health-v1/qamar.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
									<h3>Mir Qamar Ali</h3>
									<span>Assistant Professor</span>
								</div>
...
<?php include('inc/contact-details-health.php'); ?>	
