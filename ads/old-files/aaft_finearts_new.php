...
<title>Fine Arts | AAFT University</title>
		...
		<div class="row b-sec">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Bachelor of Fine Arts">Bachelor of Fine Arts</option><option value="Master of Fine Arts">Master of Fine Arts</option><option value="Diploma in Fine Arts">Diploma in Fine Arts</option>';				
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Fine Arts Programs | 2/4 years</span></p>
					<ul>
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Fine Arts is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
