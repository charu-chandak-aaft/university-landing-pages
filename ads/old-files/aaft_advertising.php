...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT | School of advertising" alt="AAFT | School of advertising" class="img-fluid lplogo">
					...
					<div class="accordion" id="accordionExample3">
							<div class="card">
								...
								<div id="collapseOne3" class="collapse show" data-parent="#accordionExample3">
									...
									<div class="card-body">
										<div class="year">2/3/4 years</div> <br>
										<ul>
			...
			<div class="col-sm-8">
				...
				<div class="row holder11">
					...
					<div class="col-sm-6 order-sm-2">
						<img decoding="async" loading="lazy" src="assets/img/course-high-advertising.webp" width="80%" alt="">
					</div>
							...
							<div class="ct-box1">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img decoding="async" loading="lazy" src="assets/img/icon1.png" alt="">
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img decoding="async" loading="lazy" src="assets/img/icon2.png" alt="">
									</div>
									<div class="col-sm-9 col-9">
								...
								<div class="row">
									...
									<div class="col-sm-2 col-2">
										<img decoding="async" loading="lazy" src="assets/img/icon3.png" alt="">
									</div>
									<div class="col-sm-9 col-9">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="placement-grid m-t-40">
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-1.jpg" class="img-fluid"></div>
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-2.jpg" class="img-fluid"></div>
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-3.jpg" class="img-fluid"></div>
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-4.jpg" class="img-fluid"></div>
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-5.jpg" class="img-fluid"></div>
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-6.jpg" class="img-fluid"></div>
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-7.jpg" class="img-fluid"></div>
					<div class="placement-list circle"><img decoding="async" loading="lazy" src="assets/img/placement/advertising-8.jpg" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-8 col-md-8">
				...
				<div class="row">
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img decoding="async" loading="lazy" src="assets/img/alumni/advertising-1.webp" class="course-image">
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img decoding="async" loading="lazy" src="assets/img/alumni/advertising-2.webp" class="course-image">
							<div class="img-content">
								<h5>Prateek Sapra</h5>
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img decoding="async" loading="lazy" src="assets/img/alumni/advertising-3.webp" class="course-image">
							<div class="img-content">
								<h5>Rachit Kapoor</h5>
								<span>Director</span>
							</div>
					...
					<div class="col-md-3 col-6">
						<div class="course-box">
							<img decoding="async" loading="lazy" src="assets/img/alumni/advertising-4.webp" class="course-image">
							<div class="img-content">
								<h5>Neelanjali</h5>
				...
				<div class="idus-visit m-t-70">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mb-mar-g2">
								<img decoding="async" loading="lazy" src="assets/img/projects/advertising-1.webp">
							</div>
						</div>
						<div class="col-md-6">
							<div class="mb-mar-g3">
								<img decoding="async" loading="lazy" src="assets/img/projects/advertising-2.webp">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row m-b-20">
						<div class="col-lg-4 col-md-4">
							<div class="course-box portfolio-wrap">
								<img decoding="async" loading="lazy" src="assets/img/common-infra1.webp" class="img-center img-fluid">
						...
						<div class="col-lg-4 col-md-4">
							<div class="course-box portfolio-wrap">
								<img decoding="async" loading="lazy" src="assets/img/common-infra2.webp" class="img-center img-fluid">
								<div class="overlay-blue portfolio-info">
									<div class="text txt-blk portfolio-links">
						...
						<div class="col-lg-4 col-md-4">
							<div class="course-box portfolio-wrap">
								<img decoding="async" loading="lazy" src="assets/img/common-infra3.webp" class="img-center img-fluid">
								<div class="overlay-blue portfolio-info">
									<div class="text txt-blk portfolio-links">
				...
				<div class="curtain swiper-container">
		            <div class="swiper-wrapper">
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img decoding="async" loading="lazy" src="assets/img/infra/advertising-1.webp" class="img-fluid">
		                		</div>
		                ...
		                <div class="swiper-slide animals">
		                    <div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img decoding="async" loading="lazy" src="assets/img/infra/advertising-2.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		                ...
		                <div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img decoding="async" loading="lazy" src="assets/img/infra/advertising-3.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
						...
						<div class="swiper-slide animals">
		                	<div class="card-img-wrap">
		                		<div class="card-img-box">
		                			<img decoding="async" loading="lazy" src="assets/img/infra/advertising-4.webp" class="img-fluid">
		                		</div>
		                		<div class="card-img-text">
		...
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<div class="bod-grid m-t-40">
					<div class="bod-list">
						<div class="circle">
							<img decoding="async" loading="lazy" src="assets/img/workshop/vikram-tyagi.webp" class="img-fluid img-center">
						</div>
						<h3>Vikram Tyagi</h3>
					...
					<div class="bod-list">
						<div class="circle">
							<img decoding="async" loading="lazy" src="assets/img/workshop/prashant-rawat.webp" class="img-fluid img-center">
						</div>
					...
					<div class="bod-list">
						<div class="circle">
							<img decoding="async" loading="lazy" src="assets/img/workshop/praphul-singh.webp" class="img-fluid img-center">
						</div>
						<h3>Praphul Singh</h3>
					...
					<div class="bod-list">
						<div class="circle">
							<img decoding="async" loading="lazy" src="assets/img/workshop/raman-vridhi.webp" class="img-fluid img-center">
						</div>
						<h3>Raman Virdi</h3>
					...
					<div class="row">
					    <div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img decoding="async" loading="lazy" src="assets/img/faculty/shweta-b.webp" class="img-fluid img-center"></div>
						...
						<div class="col-lg-3 col-md-3 col-6">
							<div class="falcutybox">
								<div class="fclty_img"><img decoding="async" loading="lazy" src="assets/img/faculty/akriti-u.webp" class="img-fluid img-center"></div>
								<div class="facultyname">
