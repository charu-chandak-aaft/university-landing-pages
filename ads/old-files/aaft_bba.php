		...
		<div class="row d-flex align-items-center">
			<div class="col-lg-8 col-md-8">
				<div class="hero_sec_content">
					...
					<h2>In BBA, Kick-start your Professional Career today!</h2>
...
<section class="white-sec" style="padding-top: 0;">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					<h1>About AAFT School of BBA</h1>
					<p>Bachelor of Business Administration (BBA) is an undergraduate academic degree program that focuses on the study of business and management principles. The program usually covers topics such as accounting, economics, marketing, organizational behaviour, finance, human resource management, and business ethics. Students who complete the program are equipped with the knowledge and skills needed to pursue careers in various industries, including finance, marketing, operations, human resources, and general management.</p>
				</div>
				...
				<div class="batchbox">
					<div class="batchbox-list">
						...
						<div class="pointer">
							<ul>
								<li>Understanding Manager Function</li>
								<li>Importance Of Human Resource Management</li>
								<li>Responsibility of  Manager In Organization</li>
								<li>Understanding  of  Accounting and Taxes</li>
								<li>Learning to Online Market Through Digital Marketing</li>
							</ul>
						</div>
					</div>
					<div class="batchbox-list">
		...
		<div class="row">
			<div class="col-sm-8 order-sm-1">
				<div class="body-copy-Black">
					<h2>Our Programs</h2>
					<p>BBA concepts are better understood when they are employed practically through projects. To impart knowledge on powerful techniques used in BBA research, marketing, and production, projects surely play a key role, and we at AAFT University ensure that our students get to work on various hands-on activities.</p>
				</div>
				<div class="">
				...
				<div class="row holder11">
					...
					<div class="col-sm-6 order-sm-1">
						...
						<ul>
							...
							<li>Importance of the Accountancy in Business</li>
							<li>Responsibilities in Human Resource and Skills</li>
							<li>Knowledge of Business Software and Computer Applications</li>
							<li>This BBA Degree course gives you an in-depth understanding of the Entrepreneurship Development as it includes real-world projects for Management Ethics with Global standards, which help you become industry-ready.</li>
		...
		<div class="row">
			<div class="col-sm-8 hold22">
				...
				<div class="row holder11">
					...
					<div class="col-sm-8 order-sm-1">
						<img src="assets/img/bba-1.jpg" width="100%" height="450px" style="border-radius: 0px;">
						...
						<div class="accordion" id="accordionExample">
							<div class="card">
								...
								<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
									<div class="card-body">
										<ul>
											<li>They will understand the advanced Business communication models in professional situations.</li>
											<li>Students will learn about involving Business Law and organizational ethics, and be able to solve the organizational issue.</li>
											<li>Student gain the knowledge of the underlying principles of management.</li>
											<li>They will be gaining analytical approach through Financial Management.</li>
											<li>They will learn the core of marketing skills.</li>
							...
							<div class="card">
								...
								<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
									<div class="card-body">
										<ul>
											<li>Students will learn the operational knowledge of the Production science.</li>
											<li>They will be gaining the relevant knowledge of Business skills to manage the project of multinational corporates.</li>
											<li>Student gain Environmental Ethics with Global set standards.</li>
											<li>Students will be taught about strategies of Cost with the Cost accountancy.</li>
											<li>They will understand the Consumer behaviour with professional tools necessary for the Organization.</li>
							...
							<div class="card">
								...
								<div id="collapseThree" class="collapse" data-parent="#accordionExample">
									<div class="card-body">
										<ul>
											<li>This semester will help you understand core of Digital Marketing, International business and Media Management. </li>
											<li>This will enhance the concepts of Advertisement.</li>
											<li>This will help students in understanding Recruitment knowledge from Human Resource management.</li>
											<li>Students will be taught about Concept of Company Accounts.</li>
											<li>They will be gaining the relevant knowledge of the banking system.</li>
							...
							<div class="card">
								...
								<div id="collapseFour" class="collapse" data-parent="#accordionExample">
									<div class="card-body">
										<ul>
											<li>In this semester, Students getting  relevant knowledge of  Research Methodology</li>
											<li>Students will be taught about  Sales management with business standards</li>
											<li>They will learn developing a practical approach through radio</li>
											<li>They will be gaining to the core of International Business.</li>
							...
							<div class="card">
								...
								<div id="collapseFive" class="collapse" data-parent="#accordionExample">
									<div class="card-body">
										<ul>
											<li>Students will be thought the professional tools necessary for the Entrepreneurship Development.</li>
											<li>This will help in development of Ethics and Industrial Relations with Labour laws.</li>
											<li>They will gain the strategy on Modern Taxation and Global tax. </li>
											<li>Get assistance for Internships in Digital Marketing, International business and Media Management. </li>
							...
							<div class="card">
								...
								<div id="collapseSix" class="collapse" data-parent="#accordionExample">
									<div class="card-body">
										<ul>
											<li>Students will get advanced knowledge of Fundamental of E-commerce.</li>
											<li>Introduction to Strategic Management & Policy used in Management. </li>
											<li>This will enhance conceptualize strategies of Management Information System.</li>
											<li>Get Placements assistance in different Media, Export& Import and Digital marketing Organizations. </li>
					...
					<div class="featured_box_group">
						<div class="featured_box_list">
							<div class="featured_box">
					          ...
					          <h3>Role 1</h3>
					          <p>Financial Advisor, Advertising Associate  </p>
					        </div>
						</div>
						<div class="featured_box_list">
							<div class="featured_box">
					          <span class="dash"></span>
					          <h3>Role 2</h3>
					          <p>Associate Media Manager, Digital marketing manager</p>
					        </div>
						</div>
						<div class="featured_box_list">
							<div class="featured_box">
					          <span class="dash"></span>
					          <h3>Role 3</h3>
					          <p>Assistant Human Resource, E-commerce marketing specialist </p>
					        </div>
						</div>
						<div class="featured_box_list">
							<div class="featured_box">
					          <span class="dash"></span>
					          <h3>Role 4</h3>
					          <p>Information and Systems Manager</p>
					        </div>
						</div>
						<div class="featured_box_list">
							<div class="featured_box">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				...
				<p  style="color:#ffffff;">Many of the staff who currently teach on this course have extensive professional experience in a range of business sectors and many maintain links with industry through consultancy and training work.</p><br>
