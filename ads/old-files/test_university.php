...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<a class="d-none d-sm-block" style="background: #ed1b24; text-align: center; padding: 10px 12px; border-radius: 4px; font-weight: bold; text-decoration: none; order:3; color:#fff;">
	...
	<div class="container">
		<div class="row reverse">
			<div class="col-sm-12">
				...
				include('inc/form-home-test.php');
				?>	
...
<section class="admission_open">
	<div class="container">
		...
		<p class="admn_dt">August 2024 Batch</p>
		<div class="row">
			<div class="col-sm-4">
				<div class="admn_text">
					<div class="img_box">
	...
	<div class="container scl">
		<div class="row">
			...
			<div class="col-sm-7">
				...
				<p>Wellness | Hospitality | Law | Doctoral Research | Fine Arts | Performing Arts | Management | Interior Design | Fashion | Digital Marketing | Animation | Journalism & Mass Communication | Photography | PR & Events | Cinema</p>
	...
	<div class="container">
		<div class="row aply">
			<div class="col-sm-6">
				...
				<p class="pt2">Last Date: 13 May 2024</p>
			</div>
