...
<title>BBA Colleges in India | AAFT University</title>
<meta name="description" content="Choose AAFT University among the leading BBA colleges in India for practical education, case-based guidance, and successful professional outcomes">
  <meta name="keywords" content="BBA colleges in India">
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT University | School of Management" alt="AAFT | School of Management" class="img-fluid lplogo">
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 100px 10px; margin-top:0px; background-image: url("assets/img/mba-v2/bba-banner-desk.webp"); background-repeat: no-repeat; background-position: center; background-size: cover;}
...
@media screen and (max-width: 1366px) and (min-width: 769px) {
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/mba-v2/bba-bg-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
	}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>BBA Program | AAFT University, Raipur</h1>
					<div class="hr2">
						<p>1 week fully paid industrial visit to Dubai</p>
					</div>
					<p class="hr3">Transform your Passion into Profit with our tailored BBA program and become the next Business mogul</p>
					<h3>3-Year on-campus program for July 2025 Batch at AAFT University</h3>
				</div>
			</div>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="BBA">BBA</option>';				
...
@media only screen and (max-width: 600px)
{
	...
	.duration1 .duration-content{background-color: #fff; border-radius: 20px; padding: 25px; padding-top: 35px; position: absolute; top: -50px;
    margin-left: -5px; box-shadow: 0px 3px 30px #00000029; margin-right: 20px; padding-top: 35px;}
...
<section class="program1">
	<div class="container">
		...
		<h2>Program Highlights</h2>
			<p>At AAFT University, a leader among BBA colleges in Raipur and Chhattisgarh, our BBA program opens doors to vast opportunities in the business world. Recognized as one of the best BBA colleges in Chhattisgarh, our curriculum covers key business disciplines, emphasizing Entrepreneurship Development and global management ethics. This blend of theory and practical projects prepares students to excel in the industry, establishing us as the best university for BBA. As a top choice among top BBA colleges in Raipur, we ensure our graduates are industry-ready, poised to become future business leaders.</p>
		</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<p>Tailor your BBA experience to fit your career goals</p>
							</div>
						</div>
			...
			<div class="col-sm-4">
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Learn about the importance of operations in Management</li>
...
<section class="excellence">
	<div class="container">
		...
		<p>Our BBA program is accredited by prestigious organizations, ensuring the highest standards of quality and value in business education.</p>
		<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseTwo2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>In addition to core courses, our BBA program offers elective courses that allow students to focus on specific areas of interest. These may include courses in entrepreneurship, consulting, sustainability, or other specialized topics.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>We use case studies to provide real-world examples of business problems and how they can be solved. This approach helps students develop critical thinking and problem-solving skills.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									<li>Our BBA program  requires students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing complex projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			...
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to core courses, our BBA program offers elective courses that allow students to focus on specific areas of interest. These may include courses in entrepreneurship, consulting, sustainability, or other specialized topics.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Case Chronicles: Real-world problem-solving</p>
					<p class="c_dtl">We use case studies to provide real-world examples of business problems and how they can be solved. This approach helps students develop critical thinking and problem-solving skills.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Team Triumphs: Collaboration and communication</p>
					<p class="c_dtl">Our BBA program  requires students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing complex projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
...
<section class="syllabus">
	<div class="container">
		...
		<div class="bbttnn">
		<div class="btn11">Projects: <span class="red"> 6+ </span> <span class="d-sm-block d-none"> | </span></div> 
		...
		<div class="accordion" id="accordionExample">
			<div class="card">
				...
				<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
					<div class="card-body">
						<ul>
						<li>Understanding the basic and advanced management Business communication theories and models in professional situations</li>
						<li>Understanding relevant case studies involving Business Law and organizational ethics, and being able to solve the organizational issues</li>
						<li>Understanding the knowledge of the underlying principles of management</li>
						<li>Focus on developing an analytical approach through Financial Management</li>
						<li>Introduction to the core of marketing skills</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="card">
				...
				<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
					<div class="card-body">
						<ul>
						<li>Understanding the operational knowledge of the Production science</li>
						<li>Gaining the relevant knowledge of Business skills to manage the projects of multinational corporates</li>
						<li>Introduction to Environmental Ethics with global set standards</li>
						<li>Conceptualize strategies of Cost with the Cost accountancy</li>
						<li>Understanding the Consumer behaviour with professional tools necessary for the organizations</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="card">
				...
				<div id="collapseThree" class="collapse" data-parent="#accordionExample">
					<div class="card-body">
						<ul>
						<li>Introduction to Digital Marketing, International Business with Media Management </li>
						<li>Getting relevant knowledge of Advertisement Concepts </li>
						<li>Understanding the Recruitment knowledge from Human Resource management</li>
						<li>Understanding  the Concept of Company Accounts</li>
						<li>Gaining knowledge of the banking system</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="card">
				...
				<div id="collapseFour" class="collapse" data-parent="#accordionExample">
					<div class="card-body">
						<ul>
						<li>Gaining relevant knowledge of  Research Methodology </li>
						<li>Understanding the aspects of Consumer Behaviour in management.</li>
						<li>Introduction to Sales management with business standards</li>
						<li>Focus on developing a practical approach through radio and digital marketing Techniques</li>
						<li>Introduction to the core of International Business.</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="card">
				...
				<div id="collapseFive" class="collapse" data-parent="#accordionExample">
					<div class="card-body">
						<ul>
							<li>Understanding the  professional tools necessary for the Entrepreneurship Development</li>
							<li>Introduction to Ethics of Industrial Relations & Labour  laws</li>
							<li>Understanding the Modern Taxation and Global tax strategy</li>
							<li>Getting Internships offers in Media management</li>
			...
			<div class="card">
				...
				<div id="collapseSix" class="collapse" data-parent="#accordionExample">
					<div class="card-body">
						<ul>
							<li>Understanding the advanced Fundamental of E-commerce models in professional situations</li>
							<li>Introduction to Strategic Management & Policy used in Management </li>
							<li>Getting conceptualize strategies of Management Information System</li>
							<li>Placements assistance in different companies or organizations</li>
...
<section class="certificate-info">
	<div class="container">
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
				<p class="bot-title2"><span>BBA Program | 3 Years</span></p>
					<ul>
		...
		<div class="swiper why">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/mba-v2/dhruvika.jpg" alt="">
							<div class="text-holder">
								<p class="nm">Dhruvika Bhartiya</p>
								<p class="des">BBA</p>										
							</div>
						</div>
						<p class="bot-txt">I am Dhruvika Bhartiya and I am pursuing International Bachelor of Business Administration from School of Business.</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/mba-v2/rudraksh.jpg" alt="">
							<div class="text-holder">
								<p class="nm">Rudraksh Chauhan</p>
								<p class="des">BBA</p>										
							</div>
						</div>
						<p class="bot-txt">I feel privileged to be a part of Asian School of Business. The experience that I am gaining here is helping me to sharpen my knowledge in the field of Information Technology. </p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/mba-v2/prashant.jpg" alt="">
							<div class="text-holder">
								<p class="nm">Prashant Negi</p>
								<p class="des">BBA</p>										
							</div>
						</div>
						<p class="bot-txt">It's been an enriching experience for me to be a part of School of Business, Raipur for my BBA course. </p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/mba-v2/bhavishya.jpg" alt="">
							<div class="text-holder">
								<p class="nm">Bhavishya Verma</p>
								<p class="des">BBA</p>										
							</div>
						</div>
						<p class="bot-txt">A Place to learn, a place to grow, an epitome of knowledge, this is what ASB is for me”. It is a joy to be a part of School of Business.</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/mba-v2/vanshika.jpg" alt="">
							<div class="text-holder">
								<p class="nm">Vanshika Raghuvanshi</p>
								<p class="des">BBA</p>										
							</div>
						</div>
						<p class="bot-txt">"I am really glad to be a part of the School of Business and life here at Raipur means all around individuals' development.</p>
					</div>
				</div>
...
<section class="program1">
	...
	<style>
		...
		.who-can .info-555{box-shadow: 0px 10px 60px #262D7614; border-radius: 20px 15px 20px 20px; padding: 25px; height: 295px; display: flex; flex-wrap: wrap; align-content: center; justify-content: center;}
		...
		<div class="row">
			<div class="col-sm-7">
					...
					<div class="row">
						<div class="col-sm-12">
							<ul>
								<li>Candidates must have a minimum of 50% marks <br>in 10+2 in any stream from a recognized board.</li>
							</ul>
						</div>
						<div class="col-sm-12">
							<ul>
			...
			<div class="col-sm-5">
				<div class="add-info">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						<li>Financial Advisor, Advertising Associate</li>
						<li>Associate Media Manager, Digital marketing manager</li>
						<li>Assistant Human Resources, E-commerce marketing specialist</li>
						<li>Information and Systems Manager</li>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample22">
			<div class="card">
				...
				<div id="collapseOne22" class="collapse show" data-parent="#accordionExample22">
					<div class="card-body">
						<ul>
							<li>The Bachelor of Business Administration (BBA) program at AAFT University has a duration of three years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseFour22" class="collapse" data-parent="#accordionExample22">
				<div class="card-body">
					<ul>
						<li>Graduates of the BBA program at AAFT University have various career opportunities in fields such as finance, marketing, operations management, human resources, and general management. They can work in diverse industries like banking, retail, hospitality, advertising, and more.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive22" aria-expanded="false">
				<span class="title">4. What is the importance of networking during a BBA program?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive22" class="collapse" data-parent="#accordionExample22">
				<div class="card-body">
					<ul>
						<li>Networking is crucial during a BBA program as it allows students to build connections with industry professionals, alumni, and peers, which can lead to internships, job opportunities, and mentorship. It also helps in gaining exposure to different industries and learning from experienced professionals.</li>
					</ul>
				</div>
			</div>
		</div>
		<div class="card">
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseSix22" aria-expanded="false">
				<span class="title">5. Can I pursue a BBA program without a business background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseSix22" class="collapse" data-parent="#accordionExample22">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the BBA program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of business principles and management practices, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-bbanew1.php'); ?>	
