...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT | School of management" alt="AAFT | School of management" class="img-fluid lplogo">
...
<section class="white-sec-2" style="padding-bottom: 0; padding:0 0 0 0; background: none;">
	<div class="container">
		<div class="row reverse">
			...
			<div class="col-lg-4 col-md-4">
				<?php
				$pageOption="PhD Management";
				$schoolOption="PHD Programme";
				$courseOption= '<option value="PhD in Management">PhD in Management</option>';				
...
<section class="white-sec" style="padding-top: 0;">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					<h2 style="line-height: 35px; margin:20px 0;">About AAFT PhD in Management Programs</h2>
					<p>PhD in management is at AAFT University is intended to help the researchers and academician of the field to explore in-depth knowledge of significant management concept. The Program helps in finding solutions to the existing problems in the field of management. The PhD in management is offered by the school of Management under different themes but not limited to, Human resource Management, <span id="choose"></span> Marketing management, Finance and accounting, operations management, retail management, strategic management, Media management, Advertising Management, Event Management, Event Management, Digital Marketing, and International Business etc.</p>
...
<?php include('inc/contact-details-new3.php'); ?>	
