...
<title>AAFT University Raipur | Best Film Schools in India</title>
<meta name="description" content="AAFT University Raipur ranks among the best film schools in India, offering expert-led courses in filmmaking, acting, direction, and more for creative careers.">
  <meta name="keywords" content="Best Film Schools in India">
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Cinema Programs | AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					/* $courseOption= '<option value="BA in Cinema">BA in Cinema</option><option value="MA in Cinema">MA in Cinema</option><option value="Diploma in Acting for Film & TV">Diploma in Acting for Film & TV</option><option value="Diploma in Post Production">Diploma in Post Production</option><option value="Diploma in Direction & Techniques">Diploma in Direction & Techniques</option><option value="Screenplay Writing">Screenplay Writing</option><option value="Diploma in Camera & Lighting">Diploma in Camera & Lighting</option>'; */
					$courseOption= '<option value="BA in Cinema">BA in Cinema</option><option value="MA in Cinema">MA in Cinema</option>';					
...
<section class="program1">
	<div class="container">
		<div class="progList mb-5">
			<div class="row">
				...
				<div class="col-sm-5">
					...
					<ul>
						<li>Diploma in Acting for Film & TV</li>
						<li>Diploma in Post Production</li>
						<li>Diploma in Direction & Techniques</li>
						<li>Screenplay Writing</li>
						<li>Diploma in Camera & Lighting</li>
					</ul>
				</div>
			</div>
		</div>
		<div class="about">
			...
			<p>The AAFT’s School of Cinema is a top-ranking film school offering industry-oriented training through UG, PG, and Diploma courses in filmmaking. If filmmaking is what interests you, gaining professional knowledge and building relevant skill sets should be a priority for you. And we are here to provide you with first-hand industry experience through our comprehensive training modules and advanced infrastructural facilities.</p>
		</div>
				...
				<div class="accordion" id="accordionExample">
					<div class="card">
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Focuses on reducing stage fright, developing confidence and understanding presentation skills.</li>
									...
									<li>Application and importance of technology in the field of photography.</li>
									<li>How to work on Adobe Photoshop.</li>
									<li>Directing and producing individually.</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="card">
						...
						<div id="collapseThree" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
							<p>Understanding early years of Indian cinema through screening, discussions and reviews.</p>
							<ul>
								<li>Aesthetics of make-up, costumes and jewellery.</li>
								<li>Understanding the significance of costumes and make-up in the entertainment industry.</li>
								<li>Developing the sense and ability of craft.</li>
								<li>Directing and producing montage and music videos individually.</li>
								<li>Understanding the process of cutting up a film and editing it.</li>
								<li>Specialization in Direction to develop students' ability to play the role of the director in creating and executing aesthetic looks and shooting plans of a screenplay in collaboration with school head, actors, key crew members, and the post-production team.</li>
							</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseFour" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Introduction to the different cultures and art forms.</li>
									<li>Understanding the essence of religions, history, political theories, beliefs, and language.</li>
									<li>Exploring Iranian, French, Latin and Korean cinema.</li>
									<li>Screening, discussions, and reviews of the films.</li>
									<li>Learning individually to direct and produce 10-12 minutes short films.</li>
									<li>Developing a sense of selecting the right location, conceiving 3D visuals.</li>
									<li>Developing the feel and look of each frame.</li>
									<li>Learning to supervise the decor and sticking to budget allocation.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseFive" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									<li>Introduction to a broad range of ethical and legal issues pertinent to film and media.</li>
									<li>Analyzing techniques to deal with moral dilemmas.</li>
									<li>Analyzing moral, legal and ethical discourse pertaining to professional communication.</li>
									<li>Focus on the rise of Indian cinema in the 90s and beyond.</li>
									<li>Learning how to market and distribute films around the globe.</li>
									<li>Understanding the trends of distribution and exhibition of films in the current scenario.</li>
									<li>Directing and producing 15-20 short films.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseSix" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								...
								<ul>
									<li>Having a show reel is not just a tool; it is the most important tool. The show reel is a resume. It is the video where every ounce of the students' efforts has to be put in to show, not only the things they have filmed, but the versatility of your editing and being able to show different styles</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Cinema Programs | 3/2 years</span></p>
					<ul>
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Bachelor of Arts in Cinema program at AAFT University has a duration of three years.</li>
						</ul>
					</div>
				</div>
			</div>
...
<?php include('inc/contact-details-new-cinemanew3.php'); ?>	
