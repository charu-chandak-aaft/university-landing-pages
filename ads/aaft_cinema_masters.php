...
<title>Cinema Master Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>M.A. in Cinema | AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="MA in Cinema">MA in Cinema</option>';				
	...
	<div class="container">
		<div class="duration-content">
			<div class="row notice1">
				...
				<hr/ class="d-block d-sm-none" style="width:92%;">
				<div class="col-sm-2 col-6">
					<div class="item6"><h5>Eligibility</h5><p style="font-size: 14px;">Graduate</p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="program1">
	<div class="container">
		<div class="about">
			...
			<p>The AAFT's School of Cinema is a top-ranking film school offering industry-oriented training through undergraduate (UG), postgraduate (PG), and diploma courses in filmmaking. If filmmaking interests you, gaining professional knowledge and building relevant skill sets should be a priority. We are here to provide you with first-hand industry experience through our comprehensive training modules and advanced infrastructural facilities. Whether you're interested in pursuing a master's in cinematography, filmmaking masters, masters in film studies, or a master’s in film, our institution caters to diverse educational needs. Our programs also cater to those interested in a film and television major, ensuring a well-rounded education in the cinematic arts.</p>
		</div>
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">M.A. in Cinema</a>
			  </li>
		</ul>
			...
			<div class="tab-pane active" id="course1" role="tabpanel">
						...
						<div id="collapseTwo2" class="collapse" data-parent="#accordionExample2">
							<div class="card-body">
								<ul>
									...
									<li>How to write a screenplay for films (short & feature films) and television at a fundamental level etc.</li>
								</ul>
							</div>
						</div>
					</div>
				<div class="card">
					...
					<div id="collapseThree2" class="collapse" data-parent="#accordionExample2">
						<div class="card-body">
							<ul>
								<li>To prepare the students to Individually direct and produce three production exercises: Mise en- scène, continuity, and dialogue in a team with other classmates.</li>
				...
				<div class="card">
					...
					<div id="collapseFour2" class="collapse" data-parent="#accordionExample2">
						<div class="card-body">
							<ul>
								<li>To make the students aware of how to produce and direct a short film.</li>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>M.A. in Cinema Program | 2 years</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for PG Diploma Program or Ph.D</li>
		...
		<div class="row">
			<div class="col-sm-7">
					...
					<div class="row">
						<div class="col-sm-6">
							<ul>
								<li>Candidates must have a graduate degree in any stream from a recognized University/Institution</li>
							</ul>
						</div>
						<div class="col-sm-6">
							<ul>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Master's Degree Program in Cinema at AAFT University has a duration of 2 years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Master's Degree program is a 10+2+3 degree in any stream from a recognized university/institution.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-new-cinemanew2.php'); ?>	
