		...
		<div class="row b-sec">
			<div class="col-sm-5">
				<div class="left-area">
					...
					<h1>Fine Arts  Programme | AAFT University, Raipur</h1>
					<div class="hr2">
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Diploma in Fine Arts">Diploma in Fine Arts</option>';				
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Easy Education Loan Available or  Pay Fees In Installment</p>
							</div>
						</div>
						<div class="brdr"></div>
					</div>
...
<section class="syllabus">
	<div class="container">
		...
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link d-none" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Bachelor</a>
			  </li>
			  <li class="nav-item d-none">
				<a class="nav-link" data-toggle="tab" href="#course2" role="tab" aria-controls="profile">Master</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course3" role="tab" aria-controls="bio">Diploma</a>
			  </li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane" id="course1" role="tabpanel">
		...
		<div class="tab-pane active" id="course3" role="tabpane3">
		...
		<div class="row">
			<div class="col-sm-7">
					...
					<div class="row">
						<div class="col-sm-6">
							<ul>
								<li>Candidates must have done 10th grade from a recognized school/institution</li>
							</ul>
						</div>
...
<?php include('inc/contact-details-finearts4.php'); ?>	
