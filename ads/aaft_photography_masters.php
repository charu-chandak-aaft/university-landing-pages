...
<title>Photography Master's Programme | AAFT University</title>
...
<nav class="navbar">
	<div class="navbar-container container">
		...
		<img src="assets/img/univ-logo.webp" title="AAFT University | School of Photography" alt="AAFT University | School of Photography" class="img-fluid lplogo">
...
<style>
	...
	.banner-area{background-color: #000; color:#fff;padding: 30px 10px 50px 10px; margin-top:70px; background-image: url("assets/img/photography-v1/photography-banner-desk.webp"); background-repeat: no-repeat; background-position: top; background-size: cover;}
	...
	.banner-area .right-area{padding:20px;	background: #8d8d8d54; border-radius: 10px; backdrop-filter: blur(10px);}
	...
	@media only screen and (max-width: 600px) {
		...
		.banner-area{background-color: #000; color:#fff; padding: 100px 0px; background-image: url("assets/img/photography-v1/photography-banner-mob.webp"); background-repeat: no-repeat; background-position: unset; background-size: unset;}
		}
</style>	
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>M.A. in Photography Program| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - July 2025 Batch</p>
					</div>
					<p class="hr3">Become Part of the Elite 1% in Photography</p>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Master of Arts in Photography">Master of Arts in Photography</option>';				
	...
	<div class="container">
		<div class="duration-content">
			<div class="row notice1">
				...
				<hr/ class="d-block d-sm-none" style="width:92%;">
				<div class="col-sm-2 col-6">
					<div class="item6"><h5>Eligibility</h5><p style="font-size: 14px;">10+2+3</p></div>
				</div>
				<div class="col-sm-2 col-6">
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About the School of Still Photography</h2>
			<p>At the School of Still Photography, we offer our next-level photography program with our MA in Photography and other postgraduate courses at SOSP. Perfect for those looking to go pro, our programs give you access to the best equipment and lessons from famous photographers. Learn by doing in top-notch studios and show off your photos at worldwide events. Whether aiming to refine your technique or explore new creative horizons, our postgraduate courses provide the perfect platform. Engage in hands-on learning in professional-grade studios and seize the opportunity to showcase your work at global festivals and in-house events.</p>
		</div>
					...
					<div class="col-sm-6">
						<div class="prog-info">
							...
							<div class="text-part">
								...
								<p>Tailor your Photography experience to fit your career goals</p>
							</div>
						</div>
				...
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						...
						<li>Learn fashion, nature, portrait, product, and wildlife photography</li>
...
<section class="excellence">
	<div class="container">
		...
		<p>Our Photography program is accredited by prestigious organizations, ensuring the highest standards of quality and value in business education.</p>
		<div class="row">
...
<section class="course-info">
	<div class="container">
		<div class="row info-top">
			<div class="col-sm-9">
				<p class="info22">Learn, Frame, and Click Professional Images at AAFT, University</p>
...
<section class="about_prog">
	<div class="container">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header" data-toggle="collapse" data-target="#collapseOne2a" aria-expanded="true">     
							<span class="title">Master the skills of Photography From all Aspects</span>
							<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
						</div>
						<div id="collapseOne2a" class="collapse show" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We offer a variety of courses that cover essential Photography topics such as fashion, travel, lifestyle, nature, food, event, aerial, or product photography.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseTwo2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>In addition to a variety of courses, our Photography programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in M.A. in Photography and Diploma in Photography.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>We provide real-world examples of the Photography Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6">
					...
					<div class="card">
						...
						<div id="collapseFour2a" class="collapse" data-parent="#accordionExample2a">
							<div class="card-body">
								<ul>
									<li>Our Photography programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row desktop">
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Master the skills of Photography From all Aspects</p>
					<p class="c_dtl">We offer a variety of courses that cover essential Photography topics such as fashion, travel, lifestyle, nature, food, event, aerial, or product photography.</p>
					<br>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					...
					<p class="c_dtl">In addition to a variety of courses, our Photography programs offer elective courses that allow students to focus on specific areas of interest. These may include courses in M.A. in Photography and Diploma in Photography.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Hands-on Equipments Learning</p>
					<p class="c_dtl">We provide real-world examples of the Photography Industry and how it runs by letting our students focus on 85% of the practical. This approach helps students develop critical thinking and problem-solving skills along with handling the equipment.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
					<p class="c_crs">Win-Win! Collaboration and Communication</p>
					<p class="c_dtl">Our Photography programs require students to work in teams on projects. This helps develop collaboration and leadership skills, as well as providing practical experience in managing mind-bending projects.</p>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="c_content">
...
<section class="syllabus">
	<div class="container">
		...
		<div class="bbttnn">
			...
			<div class="btn11">Industry Visits: <span class="red"> 8+ </span> <span class="d-sm-block d-none"> | </span></div>
			<div class="btn11">Celebrity Interactions: <span class="red"> 6+ </span> <span class="d-sm-block d-none"> | </span></div>
            <div class="btn11">Value Added Courses: <span class="red"> 5+ </span> <span class="d-sm-block d-none"> | </span></div>
			<div class="btn11">Projects: <span class="red"> 12+ </span></div>
			<a href="#enquire"><button class="btn-info2">Inquire Now</button></a>
		</div>
		
		<ul class="nav nav-tabs">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#course1" role="tab" aria-controls="home">Bachelor of Arts in Photography</a>
			  </li>
		</ul>
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									...
									<li>Students will learn the theories and principles upon which the photography is being done.</li>
									...
									<li>Students will learn from various highend image editing software so that they can get the photograph retouched with ease.</li>
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									...
									<li>Students will learn the advance creative postproduction techniques with would enhance the ability from retouching to recreating a photograph.</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapseThree" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								...
								<ul>
									<li>In this semester student will learn capturing the shimmering world of fashion & lip-smacking delicacies in food & fashion photography.</li>
									...
									<li>Students will be taught about the digital video production and visual post-production using highend equipment and techniques.</li>
						...
						<div id="collapseFour" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									...
									<li>Students will be designated with the dissertation projects for their partial fulfilment of their degree.</li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>M.A. in Photography Program | 2 years</span></p>
					<ul>
						<li>Curriculum as per the Latest Industry Trends </li>
						<li>Additionally, you can apply for a Diploma Program</li>
						<li>Get placed at top production companies in the photography industry</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row mb-3">
			<div class="col-sm-3 col-12 img-box mb-4">
				<img alt="image" loading="lazy" class="img-fluid" src="assets/img/dean/rohit-chawla.webp"
					style="color: transparent;border-left: 4px solid #ed4c38" />
			</div>
			<div class="col-sm-9 col-12 content">
				<h5>Rohit Chawla</h5>
				<p>Mr. Rohit Chawla, a celebrated photographer with over four decades of experience, has joined AAFT
					University as the Industry Dean of the School of Still Photography. Renowned for his avant-garde
					approach, minimalist design, and striking graphic style, Rohit’s illustrious career began in
					advertising at JWT before he founded his design and film production company. His globally acclaimed
					exhibitions, including Wanderlust, Tribute to Raja Ravi Varma, and Klimt - The Sequel, have been
					featured in private collections and prestigious museums. With a wealth of artistic vision and
					industry expertise, Rohit’s mentorship will empower AAFT’s photography students to explore
					contemporary techniques, innovative storytelling, and creative expression. His leadership marks a
					transformative chapter for AAFT, inspiring students to achieve excellence and carve their unique
					identities in the world of photography.</p>
			</div>
		</div>
	</div>
</section>
		...
		<div class="swiper learner">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/photography-v1/rishi.webp" alt="">
							<div class="text-holder">
								<p class="nm">Rishi Manik Das</p>
								<p class="des">HOD</p>
								<p class="dtls">He is the head of the School of Still Photography and an expert in street photography and fine art photography. He is an expert in both the technical and creative aspects of these forms of photography and has extensive experience capturing the essence of everyday life through his lens. </p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/photography-v1/arpit.webp" alt="">
							<div class="text-holder">
								<p class="nm">Arpit Agrawal</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is an expert in fashion photography and has worked with renowned fashion designers and brands. He has a keen eye for detail and is skilled in creating visually stunning images. He has expertise in capturing the essence of fashion, beauty, and style through their photographs. </p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/photography-v1/rahul.webp" alt="">
							<div class="text-holder">
								<p class="nm">Rahul Shakya</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is an expert in journalism and wildlife photography, capturing the beauty of nature with a passion. Currently, he is pursuing doctoral research. His stunning wildlife images tell a story that highlights the fragility of the natural world.</p>
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/photography-v1/atul.webp" alt="">
							<div class="text-holder">
								<p class="nm">Atul Shrivas</p>
								<p class="des">Asst. Professor</p>
								<p class="dtls">He is a versatile and dedicated photographer skilled in fashion, portrait, and wedding photography. Proficient in Adobe Photoshop and Lightroom, he has experience in diverse roles such as DOP, programmer trainee, and automation testing trainee.</p>
		...
		<div class="swiper why">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/photography-v1/mayank.webp" alt="">
							<div class="text-holder">
								<p class="nm">Mayank Sharma</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“My time at AAFT has been wonderful! We've connected with incredible faculty and talented individuals nationwide. The campus hosts exciting events and workshops with renowned photographers, boosting our self-confidence. This enhances our knowledge, providing valuable exposure in our field.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/photography-v1/jai.webp" alt="">
							<div class="text-holder">
								<p class="nm">Jai</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“The School of Still Photography has been an invaluable learning hub for me. With highly skilled and knowledgeable faculty, I've had the opportunity to develop and enhance my photography skills on campus. My experience at AAFT was truly insightful, intriguing, and inspiring!”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/photography-v1/jeffin.webp" alt="">
							<div class="text-holder">
								<p class="nm">Jeffin Philip</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“AAFT has been an all-around fantastic experience for me. It provides ample opportunities for personal growth and fosters successful careers in various fields. The exceptional professors offer constant guidance and support. The year-round events and activities ensure a vibrant and uplifting atmosphere.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
						<div class="group22">
							<img src="assets/img/photography-v1/pusp.webp" alt="">
							<div class="text-holder">
								<p class="nm">Bhumi Sharma</p>
								<p class="des"></p>										
							</div>
						</div>
						<p class="bot-txt">“During my first visit to AAFT, I was impressed by the positive energy, conducive learning environment, and availability of practical equipment for students. Despite having no prior knowledge upon admission, AAFT focuses on refining your foundation in the first semester before guiding you towards mastery.”</p>
					</div>
				</div>
				<div class="swiper-slide">
					<div class="slide-box">
...
<section class="infra_s">
	<div class="container">
		...
		<p class="s_hd">The infrastructure at AAFT School of Still Photography is designed to inspire and facilitate a modern learning environment. Equipped with the latest technology, spacious classrooms, high-speed internet connectivity, and a well-stocked library, our students have access to the tools they need to succeed. We also offer dedicated spaces for extracurricular activities, ensuring a well-rounded experience for all.</p>
		<div class="row">
			<div class="col-sm-6">
				<div class="row">
					...
					<div class="col-sm-6 p-1">
						<img src="assets/img/photography-v1/photo_infra1.webp" alt="">
					</div>
					<div class="col-sm-12 p-1">
						<img src="assets/img/photography-v1/photo_infra4.webp" alt="">
					</div>
				</div>
			</div>
			<div class="col-sm-3 p-1 d-none d-sm-block">
				<img src="assets/img/photography-v1/photo_infra2.webp" alt="">
			</div>
			<div class="col-sm-3 p-1">
				<img src="assets/img/photography-v1/photo_infra3.webp" alt="">
			</div>
		</div>
...
<section class="who-can">
	<div class="container">
		<h2>Who can apply?</h2>
		<p class="mb-5 ppp">We attract exceptional candidates who possess a blend of intellectual curiosity, leadership potential, and a passion for Photography, thereby creating a cohort of promising future leaders.</p>
		<div class="row">
			<div class="col-sm-7">
					<div class="info-555">
					...
					<div class="row">
						<div class="col-sm-6">
							<ul>
								<li>Candidates must have a 10 + 2 + 3 from a recognized University/Institution</li>
							</ul>
						</div>
						<div class="col-sm-6">
							<ul>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				<div class="card-header" data-toggle="collapse" data-target="#collapseOne223" aria-expanded="true">     
					<span class="title">1. What is the duration of the Master Program?</span>
					<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
				</div>
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Master Degree Program in Photography at AAFT University has a duration of two years.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Master Degree program is a minimum of 50% of marks in 10+2+3 from a recognized university/institution.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>After the Photography Program at AAFT University, students get various career opportunities in fields such as Photographer, Fashion Photographer, Forensic Photographer, Photo Editor, Portrait Photographer, Photojournalist and more.</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFive223" aria-expanded="false">
				<span class="title">4. Can I pursue the Photography program without a photography background or degree?</span>
				<span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
			</div>
			<div id="collapseFive223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>Yes, students from any academic background can pursue the Photography Degree program at AAFT University as long as they meet the eligibility criteria. The program is designed to provide a foundational understanding of Photography principles, and students will learn essential skills from scratch.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-photography2.php'); ?>	
