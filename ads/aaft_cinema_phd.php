...
<section class="white-sec-2" style="padding-bottom: 0; padding:0 0 0 0; background: none;">
	<div class="container">
		<div class="row reverse">
			...
			<div class="col-lg-4 col-md-4">
				<?php
				$pageOption="PhD Cinema";
				$schoolOption="PHD Programme";
				$courseOption= '<option value="PhD in Cinema">PhD in Cinema</option>';				
...
<section class="white-sec" style="padding-top: 0;">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<div class="body-copy">
					<h2 style="line-height: 35px; margin:20px 0;">About AAFT PhD in Cinema Programs</h2>
					<p>Research is an integral aspect of cinema because cinema is the mirror of the society and the way the mirror reflects the truth, similarly cinema also shows the truth of the world. AAFT University is starting PhD program to explore new possibilities of research in cinema, such as how all the technical and artistic aspects of cinema work,<span id="choose"></span> how cinema is related to life and art, importance of visual communication to human beings, to their emotional memory and to their lives.  PhD helps in uncovering all the important aspects of cinema.</p>
...
<?php include('inc/contact-details-new2.php'); ?>	
