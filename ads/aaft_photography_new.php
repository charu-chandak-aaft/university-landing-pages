...
<title>Photography | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Still Photography Programs| AAFT University, Raipur</h1>
					<div class="hr2">
						<p>Enroll for - August 2025 Batch</p>
					</div>
					<p class="hr3">Join the community of the best 1% Photographers</p>
			...
			<div class="col-sm-4"><div id="enquire" style="height:30px; margin-bottom:40px;"></div>
				<div class="right-area">
					...
					$courseOption= '<option value="Bachelor of Arts in Photography">Bachelor of Arts in Photography</option><option value="Master of Arts in Photography">Master of Arts in Photography</option><option value="Diploma in Photography">Diploma in Photography</option>';				
...
<style>
	...
	.program1 .brdr{border: 1.5px solid #F8480870; width: 300px; margin: 0 auto;}
...
<section class="program1">
	<div class="container">
			...
			<div class="row">
				<div class="col-sm-5">
					...
					<ul>
						...
						<li>Master of Arts in Photography</li>
					</ul>
				</div>
		...
		<div class="about">
			...
			<p>Learn to tell creative stories by clicking professional and captivating photographs with our photography degree courses. Our photography school has a world-class infrastructure where students get to work in professional-grade studios. They also have opportunities to learn from celebrity photographers and showcase their talent at various global festivals and in-house events throughout their studies.</p>
		</div>
		...
		<div class="row cert-top">
			...
			<div class="col-sm-5">
				<div class="cert-bot">
					...
					<p class="bot-title2"><span>Photography Programs | 2/3 years</span></p>
					<ul>
						...
						<li>Get placed at top production companies in the PhotographyIndustry</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="swiper learner">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="s_holder">
						<div class="f-box">
						<img src="assets/img/photography-v1/namrata.webp" alt="">
						<div class="text-holder">
							<p class="nm">Namrata Chandrakar</p>
							<p class="des">Asst. Professor</p>
							<p class="dtls">She is a contemporary fashion and food photography expert. With a unique style, she captures unconventional fashion and the artistry of food, showcasing them in visually appealing ways. She guides students to explore their creativity and experiment with new techniques in the field. </p>
	...
	<div class="container">
		...
		<div class="card">
			...
			<div id="collapseFour223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>After the Photography Program at AAFT University, students get various career opportunities in fields such as Photographer, Fashion Photographer, Forensic Photographer, Photo Editor, Portrait Photographer, and more.</li>
					</ul>
				</div>
			</div>
		</div>
...
<?php include('inc/contact-details-photography3.php'); ?>	
