...
<style type="text/css">
	...
	input.register-input-box, select.register-input-box {font-size: 11px;}
</style>
...
<input type="hidden" id="UTM_adgroup" name="UTM_adgroup" value="<?php echo isset($_GET['UTM_adgroup']) ? htmlspecialchars($_GET['UTM_adgroup']) : ''; ?>">
	<input type="hidden" id="mx_UTM_adgroup" name="mx_UTM_adgroup" value="<?php echo isset($_GET['mx_UTM_adgroup']) ? htmlspecialchars($_GET['mx_UTM_adgroup']) : ''; ?>">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="form-group">
							<select name="time" required="" class="register-input-box" id="id_time" style="font-size: 11px!important; font-weight: 600;">
								<option value="" selected="selected">Select Suitable Time For A Call*</option>
								<option value="10:30 AM to 12:30 PM">10:30 AM to 12:30 PM</option>
								<option value="12:30 PM to 2:00 PM">12:30 PM to 2:00 PM</option>
								<option value="02:00 PM to 4:00 PM ">02:00 PM to 4:00 PM </option>
								<option value="04:00 PM to 6:00 PM">04:00 PM to 6:00 PM</option>
							</select>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							...
							<select name="" required class="register-input-box" id="id_School1" onChange="setBlankSchool(this)">
				...
				<div class="row">
					<div class="col-sm-9">
<div class="checkbox">
							<p class="p-0"><input id="agreeCheckbox" type="checkbox" name="checkbox">&nbsp; I
								acknowledge and agree to the <a target="_blank" href="/terms-and-conditions">Terms and
									Conditions</a> of AAFT University, including the admission policies, privacy, and
								code of conduct.</p>
					</div>
					...
					<div class="col-sm-3">
						<div class="form-btn-wrap">
							<input id="subBtn" type="submit" name="" class="form-btn" value="ENQUIRE NOW" title="ENQUIRE NOW" onclick="checkDetailsEnq()">
