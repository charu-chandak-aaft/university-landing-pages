...
function GetCampaignUrlName(){
	...
	//Get newlp position from Current Url
	$adPos = strpos($url,"ad");
	$adPos = $adPos+3;
	...
	//$res=array("campaignName"=>$campaignName,"pageId"=>$pageId,"schoolId"=>$schoolId,"schoolName"=>$schoolName,"lpName"=>$pageName);
	$res=array("lpName"=>$pageName);
	return $res;
}

function InsertFormData($v1,$v2,$v3,$v4,$v5,$v6,$v7,$v8,$v9,$v10,$v11,$v12,$v13,$v14,$v15,$v16,$v17,$v18,$v19,$v20,$v21,$v22,$v23,$v24,$v25,$v26,$v27,$v28,$v29){
	$servername = "192.186.179.2";
	$username = "aaft_dbuser";
	$password = "?4IYzmqDB(8+";
	$dbname = "aaft_website_content";
	...
	$sql1 = "INSERT INTO data_course_lp_new (student, contact, email, course_id, qual_id, state_id, city_id, source, school_id, school_name, page_name, otp, remark, map, utm_source, utm_medium, utm_campaign, utm_content, utm_term, utm_creative, gclid, utm_campaignid, utm_adgroupid, utm_creativeid, utm_matchtype, utm_device, utm_network, utm_keyword, utm_placement) VALUES ('$v1','$v2','$v3','$v4','$v5','$v6','$v7','$v8','$v9','$v10','$v11','$v12','$v13','$v14','$v15','$v16','$v17','$v18','$v19','$v20','$v21','$v22','$v23','$v24','$v25','$v26','$v27','$v28','$v29')";
	$conn->query($sql1);
}

function SubmitConditionalData($Name,$Phone,$Emailid,$CourseId,$QualId,$StateId,$CityId,$Source,$SchoolId,$SchoolName,$PageName,$Otp,$Remark,$map,$gclid,$utm_source,$utm_medium,$utm_campaign,$utm_content,$utm_term,$utm_creative,$TempID,$AuthID,$ReUrl, $utm_campaignid, $utm_adgroupid, $utm_creativeid, $utm_matchtype, $utm_device, $utm_network, $utm_keyword, $utm_placement){
	$res="";
	if($Name!='' && $Emailid!='' && is_numeric($Phone) && $Phone!='' && $CourseId!='' && $StateId!=''){
			...
			InsertFormData($Name,$Phone,$Emailid,$CourseId,$QualId,$StateId,$CityId,$Source,$SchoolId,$SchoolName,$PageName,$Otp,$Remark,$map,$utm_source,$utm_medium,$utm_campaign,$utm_content,$utm_term,$utm_creative,$gclid,$utm_campaignid, $utm_adgroupid, $utm_creativeid, $utm_matchtype, $utm_device, $utm_network, $utm_keyword, $utm_placement);
			if($map!="Brochure"){
			...
			//unComment below code for remove OTP
...
function GetFormData($mobile){
	...
	$sql1 = "SELECT id, fillcount, course_id, otp_varified, updated_on, created_on FROM data_course_lp_new WHERE contact=".$mobile." ORDER by id DESC limit 0,1";
...
function UpdateFormData($Otp,$Phone,$attempt,$recordId,$utm_source,$utm_medium,$utm_campaign,$utm_content,$TempID,$AuthID,$ReUrl,$map){
	$servername = "192.186.179.2";
	$username = "aaft_dbuser";
	$password = "?4IYzmqDB(8+";
	$dbname = "aaft_website_content";
	...
	$sql1 = "UPDATE data_course_lp_new SET fillcount=".$attempt.", otp=".$Otp.", created_on=now() WHERE id=".$recordId;
	$result1 = $conn->query($sql1);
...
function UpdateOtpStatus($otp,$mobile){
	...
	$sql1 = "UPDATE data_course_lp_new SET otp_varified=1 WHERE otp=".$otp." and contact=".$mobile;
	$result1 = $conn->query($sql1);
}
