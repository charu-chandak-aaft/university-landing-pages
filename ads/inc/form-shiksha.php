...
<div class="" id="enquire-cta">
	<h3 style="color:#ed3237; text-align:center;">ENQUIRY FORM</h3>
...
<div class="checkbox">
  <p style="color:#5e5e5e!important">
	...
	<div class="form-btn-wrap">
		<input id="subBtn" type="submit" name="" class="form-btnzz" value="ENQUIRE NOW" title="ENQUIRE NOW" onclick="checkDetailsEnq()">
