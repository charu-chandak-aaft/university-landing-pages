...
{ ?>
	<div class="mob-cta mobile-view">
		<div class="container-fluid">
			<div class="row">
				<div class="col-6">
					<a href="tel:08069152355" class="callusbot"><i class="bi bi-telephone"></i> CALL US</a>
				</div>
				<div class="col-6">
					<a href="https://wa.me/919109112068" class="chatbot"><i class="bi bi-whatsapp"></i> Whatsapp</a>
...
<?php } 
	...
	<div class="mob-cta mobile-view">
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<!--<a href="https://wa.me/919109170249" class="chatbot"><i class="bi bi-whatsapp"></i> Whatsapp</a>-->
					<!--<a href="https://api.whatsapp.com/send/?phone=919109208560&text=Hi, I would like to know more about bba-llb degree program" class="chatbot"><i class="bi bi-whatsapp"></i> Whatsapp</a>-->
          <a href="#enquire" class="chatbot"><i class="bi bi-chat-square-text-fill"></i> ENROLL NOW</a>
				</div>
			</div>
...
.my-float{
  ...
  <a href="https://api.whatsapp.com/send/?phone=919109170249&text=Hi, I would like to know more about courses offered by aaft university" class="whatsappfloat" target="_blank">
