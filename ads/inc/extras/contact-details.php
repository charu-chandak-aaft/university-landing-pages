	...
	<div class="container">
		<div class="row reverse">
			<div class="col-lg-8 col-md-8">
				<address>
					<div>Our <span class="clr458">Campus</span></div>

					<div>Marwah Studios Complex<br><span class="clr458"><strong>Delhi-NCR</strong></span></div>

					<div>FC-14/15, Sector-16A Film City Noida, Uttar Pradesh- 201301, India</div>

					<div style="display:none;"><strong>Call us:</strong> <a href="tel:+919109112056" class="link">+91 9109112056</a></div>
					<!--<div><strong>Email:</strong> <a href="mailto:help@aaft.com" class="link">help@aaft.com</a></div>-->
				</address>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<p class="copyright">Copyright 2022 AAFT.</p>
			</div>
		</div>
	</div>
</footer>
