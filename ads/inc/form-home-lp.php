...
<div class="form-group relative col-md-9"><div class="checkbox"><p class="p-0"><input id="agreeCheckbox" type="checkbox" name="checkbox">&nbsp; I acknowledge and agree to the <a target="_blank" href="/terms-and-conditions">Terms and Conditions</a> of AAFT University, including the admission policies, privacy, and code of conduct.</p></div><span class="landing-form-error"></span></div>
				</div>
			<!--</form>-->
		</div>
	</div>
