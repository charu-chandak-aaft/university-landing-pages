...
(empty($_GET['mx_UTM_Source'])) ? $utm_source = "" : $utm_source = $_GET['mx_UTM_Source'];
(empty($_GET['mx_UTM_Medium'])) ? $utm_medium = "" : $utm_medium = $_GET['mx_UTM_Medium'];
(empty($_GET['mx_UTM_Campaign'])) ? $utm_campaign = "" : $utm_campaign = $_GET['mx_UTM_Campaign'];
(empty($_GET['mx_UTM_Term'])) ? $utm_term = "" : $utm_term = $_GET['mx_UTM_Term'];
...
(empty($_GET['mx_UTM_Campaignid'])) ? $utm_campaignid = "" : $utm_campaignid = $_GET['mx_UTM_Campaignid'];
(empty($_GET['mx_UTM_adgroupid'])) ? $utm_adgroupid = "" : $utm_adgroupid = $_GET['mx_UTM_adgroupid'];
(empty($_GET['mx_UTM_creativeid'])) ? $utm_creativeid = "" : $utm_creativeid = $_GET['mx_UTM_creativeid'];
(empty($_GET['mx_UTM_matchtype'])) ? $utm_matchtype = "" : $utm_matchtype = $_GET['mx_UTM_matchtype'];
(empty($_GET['mx_UTM_device'])) ? $utm_device = "" : $utm_device = $_GET['mx_UTM_device'];
(empty($_GET['mx_UTM_network'])) ? $utm_network = "" : $utm_network = $_GET['mx_UTM_network'];
(empty($_GET['mx_UTM_Keyword'])) ? $utm_keyword = "" : $utm_keyword = $_GET['mx_UTM_Keyword'];
(empty($_GET['mx_UTM_placement'])) ? $utm_placement = "" : $utm_placement = $_GET['mx_UTM_placement'];
(empty($_GET['mx_GCLID'])) ? $gclid = "" : $gclid = $_GET['mx_GCLID'];
...
function ConnectionAws()
{
	$servername = "aaftonline-land.cbywz5clu6jg.ap-south-1.rds.amazonaws.com";
	$username = "admin";
	$password = "CTrJLv4MZxTSCtB2";
	$dbname = "aaft_university_wp";
	$conn = new mysqli($servername, $username, $password, $dbname);
	if ($conn->connect_error) {
		die("Connection failed: " . $conn->connect_error);
	}
...
function GetSchoolDropU()
{
	$conn = Connection();
	$sql1 = "SELECT id, name, code FROM school WHERE status=1";
	$result1 = $conn->query($sql1);
	if ($result1->num_rows > 0) {
		// output data of each row
		$i = 0;
...
function GetByEmail($secretKey, $accessKey, $val1)
{
	...
	if ($err) {
		...
		if (is_array($resultdata) && isset($resultdata[0]->ProspectID)) {
			$result = $resultdata[0]->ProspectID;
		} elseif (isset($resultdata->ProspectID)) { // If it's a single object
			$result = $resultdata->ProspectID;
		}
	}
...
function leadSqCrtOld($secretKey, $accessKey, $val1, $val2, $val3, $val4, $val5, $val6, $val7, $val8, $val9, $val10, $val11, $val12, $val13, $val14, $val15, $val16, $val17, $val18, $val19, $val20, $val21, $val22, $val23, $mx_UTM_Source ='', $mx_UTM_Medium='', $mx_UTM_Keyword='', $mx_UTM_creativeid='', $mx_UTM_Campaign=''
)
{
	$data_string = '[{"Attribute":"FirstName","Value":"' . $val1 . '"},
		...
		{"Attribute":"mx_UTM_Source","Value":"' . $mx_UTM_Source . '"},
		{"Attribute":"mx_UTM_Medium","Value":"' . $mx_UTM_Medium . '"},
		{"Attribute":"mx_UTM_Keyword","Value":"' . $mx_UTM_Keyword . '"},
		{"Attribute":"mx_UTM_creativeid","Value":"' . $mx_UTM_creativeid . '"},
		{"Attribute":"mx_UTM_Campaign","Value":"' . $mx_UTM_Campaign . '"},
...
function leadSqCrt_8april23($secretKey, $accessKey, $val1, $val2, $val3, $val4, $val5, $val6, $val7, $val8, $val9, $val10, $val11, $val12, $val13, $val14, $val15, $val16, $val17, $val18, $val19, $val20, $val21, $val22, $val23, $val24)
{
	$data_string = '[{"Attribute":"FirstName","Value":"' . $val1 . '"},
		{"Attribute":"EmailAddress","Value":"' . $val2 . '"},
		{"Attribute":"Phone","Value":"' . $val3 . '"},
...
function leadSqCrt($secretKey, $accessKey, $val1, $val2, $val3, $val4, $val5, $val6, $val7, $val8, $val9, $val10, $val11, $val12, $val13, $val14, $val15, $val16, $val17, $val18, $val19, $val20, $val21, $val22, $val23, $val24, $mx_UTM_Source ='', $mx_UTM_Medium='', $mx_UTM_Keyword='', $mx_UTM_creativeid='', $mx_UTM_Campaign='', $UTM_adgroup='', $mx_UTM_adgroup='')
{
	...
	$data_string = '[{"Attribute":"FirstName","Value":"' . $val1 . '"},
		...
		{"Attribute":"mx_UTM_creativeid","Value":"' . $mx_UTM_creativeid . '"},
		{"Attribute":"mx_UTM_Campaign","Value":"' . $mx_UTM_Campaign . '"},
		{"Attribute":"mx_UTM_adgroup","Value":"' . $mx_UTM_adgroup . '"},
		{"Attribute":"mx_Lead_URL","Value":"' . $val24 . '"}]';
	try {
		$curl = curl_init('https://api-in21.leadsquared.com/v2/LeadManagement.svc/Lead.Capture?accessKey=' . $accessKey . '&secretKey=' . $secretKey);
		curl_setopt($curl, CURLOPT_CUSTOMREQUEST, "POST");
		...
		// // Set the header to JSON for easy debugging in the Network tab
...
function leadSqUpdt($secretKey, $accessKey, $val1, $val2, $val3, $val4, $val5, $val6, $val7, $val8, $val9, $val10, $val11, $val12, $val13, $val14, $val15, $val16, $val17, $val18, $val19, $val20, $val22, $val23, $val24, $leadidNw,  $mx_UTM_Source ='', $mx_UTM_Medium='', $mx_UTM_Keyword='', $mx_UTM_creativeid='', $mx_UTM_Campaign='', $UTM_adgroup='', $mx_UTM_adgroup='')
{
	$data_string = '[{"Attribute":"FirstName","Value":"' . $val1 . '"},
		{"Attribute":"EmailAddress","Value":"' . $val2 . '"},
		{"Attribute":"Phone","Value":"' . $val3 . '"},
	...
	// $data_array = [
	// 	["Attribute" => "FirstName", "Value" => $val1],
	// 	["Attribute" => "EmailAddress", "Value" => $val2],
	// 	["Attribute" => "Phone", "Value" => $val3],
	// 	["Attribute" => "ProspectStage", "Value" => "Lead"],
	// 	["Attribute" => "SearchBy", "Value" => "Phone"],
...
function leadSqUpdt_8april23($secretKey, $accessKey, $val1, $val2, $val3, $val4, $val5, $val6, $val7, $val8, $val9, $val10, $val11, $val12, $val13, $val14, $val15, $val16, $val17, $val18, $val19, $val20, $val21, $val22, $val23)
{
	$data_string = '[{"Attribute":"FirstName","Value":"' . $val1 . '"},
		{"Attribute":"EmailAddress","Value":"' . $val2 . '"},
		{"Attribute":"Phone","Value":"' . $val3 . '"},
...
function getWrongUrl()
{
	...
	if (count($srcval) == 1) {
		...
		$redirect = header("Location: https://aaftgroup.com/");
	}
	return $redirect;
}
