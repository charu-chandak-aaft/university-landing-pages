<script>
	...
	function checkDetailsEnq() {
		...
		var v10 = document.getElementById('id_School').value;
   		var checked =$("#agreeCheckbox").prop('checked');
		...
		if (v1 == '' || v2 == '' || (v3 < 1111111111 || v3 > 9999999999) || v4 == '' || v5 == '' || v6 == '' || v8 == '' || v9 == '' || v10 == '') {
			...
			if (v2v1 == true && v2v2 == false && v2v3x == true && v2v4 == false && v2v5 == false && v2v6 == false && v2v7 == false) {
				...
				//disable the button avodiing multiple submitst 
	...
	function submitData() {
		...
		let mx_UTM_Source = document.getElementById("mx_UTM_Source").value;
		let mx_UTM_Medium = document.getElementById("mx_UTM_Medium").value;
		let mx_UTM_Keyword = document.getElementById("mx_UTM_Keyword").value;
		let mx_UTM_creativeid = document.getElementById("mx_UTM_creativeid").value;
		let mx_UTM_Campaign = document.getElementById("mx_UTM_Campaign").value;
		let UTM_adgroup = document.getElementById("UTM_adgroup").value;
		let mx_UTM_adgroup = document.getElementById("mx_UTM_adgroup").value;
