...
{ ?>
	<div class="mob-cta mobile-view">
		<div class="container-fluid">
			<div class="row">
				<div class="col-6">
					<a href="tel:+919109018970" class="callusbot"><i class="bi bi-telephone"></i> CALL US</a>
				</div>
				<div class="col-6">
...
.my-float{
  ...
  <a href="https://api.whatsapp.com/send/?phone=918447006467&text=Hi, I would like to know more about school of cinema programs" class="whatsappfloat" target="_blank">
