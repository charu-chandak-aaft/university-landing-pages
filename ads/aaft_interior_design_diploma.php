...
<title>Interior Design  Diploma Programme | AAFT University</title>
		...
		<div class="row b-sec">
			<div class="col-sm-6">
				<div class="left-area">
					...
					<h1>Diploma in Interior Design | AAFT University, Raipur</h1>
					<div class="hr2">
...
<section class="program1">
	<div class="container">
		<div class="about">
			<h2>About School of Interior Design</h2>
			<p>Are you also fascinated with aesthetically pleasing places? If interior design is what you love, the AAFT School of Interior Design offers a diverse range of undergraduate, postgraduate, and diploma courses for students eager to make a career in interior design. At AAFT, we help students refine their artistic abilities, enabling them to maximize the potential of any space. Our interior design programs focus on the use of color, lighting, layout, fabrics, furniture, and the importance of Vaastu Shastra, which can help transform a space into a captivating area.</p>
		</div>
				...
				<div class="prog-info2">
					...
					<div class="grid-container">
					  <ul style="color:#000;">
						  ...
						  <li>Get mentored by Padma Shri Awardee, Sunita Kohli</li>
					</ul>
					</div>
				</div>
			</div>
				...
				<div class="accordion" id="accordionExample">
					<div class="card">
						...
						<div id="collapseOne" class="collapse show" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
                                     <li>Basic Design and Visual Arts</li>
									  <li>Introduction to AutoCAD</li>
									  <li>Building Materials and Construction Technology - I</li>
									  <li>Room Space Design</li>
									  <li>Interior Materials - I</li>
					...
					<div class="card">
						...
						<div id="collapseTwo" class="collapse" data-parent="#accordionExample">
							<div class="card-body">
								<ul>
									 <li>Furniture Design - I</li>
									  <li>SketchUp</li>
									  <li>Building Materials &amp; Construction Technology - I</li>
									  <li>Residential Space Design</li>
									  <li>Interior Materials - II</li>
	...
	<div class="container">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-9 col-12 content">
				<h5>Sunita Kohli</h5>
				<p>Step into the world of design excellence at AAFT, where the illustrious Ms. Sunita Kohli leads a transformative journey in interior design education. A distinguished figure in the field, Ms. Kohli has redefined the art of interiors with her extraordinary vision and dedication to preserving architectural heritage. Recipient of the prestigious Padma Shri, her career is a testament to her unparalleled expertise and contributions to design, restoration, and craftsmanship. Her work, known for its timeless elegance and cultural relevance, has set benchmarks in the industry. As the new Industry Dean for the AAFT School of Interior Design, Ms. Kohli brings her wealth of knowledge to inspire and mentor the next generation of designers. Under her guidance, students will explore innovative design approaches and embrace the art of creating spaces that leave a lasting impact.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="accordion" id="accordionExample223">
			<div class="card">
				...
				<div id="collapseOne223" class="collapse show" data-parent="#accordionExample223">
					<div class="card-body">
						<ul>
							<li>The Diploma in Interior Design at AAFT University has a duration of 1 Year.</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="card">
			...
			<div id="collapseThree223" class="collapse" data-parent="#accordionExample223">
				<div class="card-body">
					<ul>
						<li>The eligibility criteria for the Bachelor program is a minimum of 50% of marks in 10+2 or Graduate in any stream from a recognized board, whereas for Diploma programs, it's a minimum of 50% of marks in grade 10.</li>
					</ul>
				</div>
			</div>
		</div>
